...
export class ZipFile extends EventEmitter {
    ...
    fileSize: number;
    /**
     * When non-null, the central directory iteration terminates once the
     * cursor reaches this offset (lenient CD-scan mode used for archives
     * with broken EOCDR metadata, mirroring java.util.zip behaviour).
     */
    centralDirectoryEndOffset: number | null;
    isOpen: boolean;
    lazyEntries: boolean;

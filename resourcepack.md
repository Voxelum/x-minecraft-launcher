...
```ts
readIcon(resourcePack: string | Uint8Array<ArrayBufferLike> | FileSystem): Promise<Uint8Array<ArrayBufferLike>>
```
...
<strong>Defined in:</strong> <a href="https://github.com/Voxelum/x-minecraft-launcher/blob/master/packages/resourcepack/index.ts#L89" target="_blank" rel="noreferrer">packages/resourcepack/index.ts:89</a>
</p>
...
```ts
readPackMeta(resourcePack: string | Uint8Array<ArrayBufferLike> | FileSystem): Promise<Pack>
```
#### Parameters
...
<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/Voxelum/x-minecraft-launcher/blob/master/packages/resourcepack/index.ts#L57" target="_blank" rel="noreferrer">packages/resourcepack/index.ts:57</a>
</p>
...
```ts
readPackMetaAndIcon(resourcePack: string | Uint8Array<ArrayBufferLike> | FileSystem): Promise<{ icon: Uint8Array<ArrayBufferLike> | undefined; metadata: Pack }>
```
...
- `Promise<{ icon: Uint8Array<ArrayBufferLike> | undefined; metadata: Pack }>`

<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/Voxelum/x-minecraft-launcher/blob/master/packages/resourcepack/index.ts#L106" target="_blank" rel="noreferrer">packages/resourcepack/index.ts:106</a>
</p>

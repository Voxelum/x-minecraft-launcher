...
```ts
openFileSystem(basePath: string | Uint8Array<ArrayBufferLike>): Promise<FileSystem>
```
#### Parameters

- **basePath**: `string | Uint8Array<ArrayBufferLike>`
#### Return Type

- `Promise<FileSystem>`

<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/Voxelum/x-minecraft-launcher/blob/master/packages/system/index.ts#L23" target="_blank" rel="noreferrer">packages/system/index.ts:23</a>
</p>
...
```ts
resolveFileSystem(base: string | Uint8Array<ArrayBufferLike> | FileSystem): Promise<FileSystem>
```
#### Parameters

- **base**: `string | Uint8Array<ArrayBufferLike> | FileSystem`
#### Return Type

- `Promise<FileSystem>`

<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/Voxelum/x-minecraft-launcher/blob/master/packages/system/index.ts#L73" target="_blank" rel="noreferrer">packages/system/index.ts:73</a>
</p>

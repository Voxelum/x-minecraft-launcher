...
```ts
forge.installer: WithDownload<{ path: string; version: string }>
```
<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/Voxelum/x-minecraft-launcher/blob/master/packages/installer/forge.ts#L23" target="_blank" rel="noreferrer">packages/installer/forge.ts:23</a>
</p>

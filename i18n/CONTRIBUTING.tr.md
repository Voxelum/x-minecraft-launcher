### Teknoloji Yığını ve Proje Mimarisi

Projede kullanılan araçlar ve teknolojilere genel bakış:

- [Node.js >=18.17.0](https://nodejs.org/): Temel kütüphane çalışma ortamı.
- [Electron 27](https://electron.atom.io): Masaüstü uygulama çalışma ortamı.
- [pnpm](https://pnpm.io/): Monorepo paket yöneticisi.
- [TypeScript](https://www.typescriptlang.org/): Projenin ana dili.
- [Vue & Vite](https://vuejs.org/): Kullanıcı arayüzü ve derleme sistemi.
...
### Katkıda Bulunmaya Başlarken

1. **Alt modüllerle birlikte klonlayın**:
   ```bash

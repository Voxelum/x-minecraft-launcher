...
Panoramica degli strumenti e delle tecnologie utilizzate:

- [Node.js >=18.17.0](https://nodejs.org/): Ambiente di runtime per le librerie di base.
- [Electron 27](https://electron.atom.io): Ambiente di runtime dell'applicazione desktop.
- [pnpm](https://pnpm.io/): Gestore di pacchetti del monorepo.
- [TypeScript](https://www.typescriptlang.org/): Linguaggio principale del progetto.
- [Vue & Vite](https://vuejs.org/): Interfaccia utente e sistema di build.
...
1. **Clonare il repository con i sottomoduli**:
   ```bash
...
3. **Avviare il server di sviluppo**:
   ...
   pnpm dev
   ```
4. **Verificare tipi e stile del codice**:
   ```bash
   pnpm check
   pnpm lint
   ```

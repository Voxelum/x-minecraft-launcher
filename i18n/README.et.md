...
Rakenduse allalaadimiseks külastage [ametlikku veebisaiti](https://xmcl.app)!

Kui teil on winget installitud:

```bash
winget install CI010.XMinecraftLauncher
```

Paigaldamine Homebrew (macOS tap) kaudu:
...
Linuxis on XMCL saadaval ka Flathubis:
...
- 📥 **Automaatne allalaadimine ja täiendamine**. Tugi `Minecraft`, `Forge`, `Fabric`, `Quilt`, `OptiFine`, `JVM` allalaadimiseks.
- ⚡️ **Kiire allalaadimine**. Ühenduste taaskasutus ja failide paralleelne mitmelõimeline allalaadimine.
- 💻 **Platvormideülene**. Põhineb Electronil: 🗔 Windows 10/11, 🍎 macOS ja 🐧 Linux.
- 📚 **Mitme profiili haldus**. Looge eraldiseisvad profiilid mänguversioonide, modifikatsioonide ja seadete jaoks.
- 🗂 **Tõhus ressursihaldus**. Kõvade ja sümbollinkide kasutamine kettaruumi säästmiseks ilma failide dubleerimiseta! 😆
- 🔥 **Integreeritud CurseForge & Modrinth**. Otsige ja laadige ressursse otse käivitajas.
- 📦 **Modipakkide import ja eksport**. Täielik ühilduvus CurseForge ja Modrinth standarditega!
- 🔒 **Mitme konto tugi**. Microsofti sisselogimine, Mojang Yggdrasil API, [ely.by](https://ely.by/) ja kohandatud serverid!
- 🔗 **P2P mitmikmäng**. Mängige sõpradega virtuaalses kohtvõrgus üle interneti ilma keeruliste võrguseadistusteta!
- 🔑 **Koodiallkirjastamine ja kaasaegsed paketid**. Windowsis toetatakse `appx` ja `appinstaller` pakette ilma SmartScreen hoiatusteta! 😎

## Tuumikteegid (Core Libraries)

See repositoorium sisaldab ka **Minecraft Launcher Core** (`@xmcl/*`) npm-pakette Minecrafti käivitajate ehitamiseks. [API dokumentatsioon](https://docs.xmcl.app/en/core)

| Package | Description | Version |
| --- | --- | --- |
| [@xmcl/core](../packages/core) | Minecrafti käivitamine | [![npm](https://img.shields.io/npm/v/@xmcl/core.svg)](https://www.npmjs.com/package/@xmcl/core) |
| [@xmcl/installer](../packages/installer) | Minecraft, Forge, Fabric, Quilt, OptiFine, JVM paigaldamine | [![npm](https://img.shields.io/npm/v/@xmcl/installer.svg)](https://www.npmjs.com/package/@xmcl/installer) |
| [@xmcl/user](../packages/user) | Kasutaja autentimine ja nahad (skinid) | [![npm](https://img.shields.io/npm/v/@xmcl/user.svg)](https://www.npmjs.com/package/@xmcl/user) |
| [@xmcl/mod-parser](../packages/mod-parser) | Forge/LiteLoader/Fabric modide parsimine | [![npm](https://img.shields.io/npm/v/@xmcl/mod-parser.svg)](https://www.npmjs.com/package/@xmcl/mod-parser) |
...
| [@xmcl/nbt](../packages/nbt) | NBT andmete parsimine | [![npm](https://img.shields.io/npm/v/@xmcl/nbt.svg)](https://www.npmjs.com/package/@xmcl/nbt) |
| [@xmcl/game-data](../packages/game-data) | Maailma andmete või servers.dat laadimine | [![npm](https://img.shields.io/npm/v/@xmcl/game-data.svg)](https://www.npmjs.com/package/@xmcl/game-data) |
| [@xmcl/resourcepack](../packages/resourcepack) | Ressursipakkide parsimine | [![npm](https://img.shields.io/npm/v/@xmcl/resourcepack.svg)](https://www.npmjs.com/package/@xmcl/resourcepack) |
| [@xmcl/gamesetting](../packages/gamesetting) | Mänguseadete parsimine | [![npm](https://img.shields.io/npm/v/@xmcl/gamesetting.svg)](https://www.npmjs.com/package/@xmcl/gamesetting) |
| [@xmcl/client](../packages/client) | Minecrafti kliendi võrgutööriistad | [![npm](https://img.shields.io/npm/v/@xmcl/client.svg)](https://www.npmjs.com/package/@xmcl/client) |
| [@xmcl/model](../packages/model) | Mängijate ja plokkide 3D-mudelite kuvamine | [![npm](https://img.shields.io/npm/v/@xmcl/model.svg)](https://www.npmjs.com/package/@xmcl/model) |
| [@xmcl/text-component](../packages/text-component) | Minecrafti tekstikomponentide parsimine | [![npm](https://img.shields.io/npm/v/@xmcl/text-component.svg)](https://www.npmjs.com/package/@xmcl/text-component) |
| [@xmcl/forge-site-parser](../packages/forge-site-parser) | Forge veebisaidi parsimine | [![npm](https://img.shields.io/npm/v/@xmcl/forge-site-parser.svg)](https://www.npmjs.com/package/@xmcl/forge-site-parser) |
| [@xmcl/file-transfer](../packages/file-transfer) | Suure jõudlusega failide allalaadimine | [![npm](https://img.shields.io/npm/v/@xmcl/file-transfer.svg)](https://www.npmjs.com/package/@xmcl/file-transfer) |
| [@xmcl/nat-api](../packages/nat-api) | UPnP ja NAT-PMP pordi suunamine | [![npm](https://img.shields.io/npm/v/@xmcl/nat-api.svg)](https://www.npmjs.com/package/@xmcl/nat-api) |
| [@xmcl/system](../packages/system) | FS vahetarkvara brauserile/Nodele | [![npm](https://img.shields.io/npm/v/@xmcl/system.svg)](https://www.npmjs.com/package/@xmcl/system) |
| [@xmcl/unzip](../packages/unzip) | yauzl zip lahtipakkija ümbris | [![npm](https://img.shields.io/npm/v/@xmcl/unzip.svg)](https://www.npmjs.com/package/@xmcl/unzip) |
| [@xmcl/semver](../packages/semver) | Fabric semver vorming | [![npm](https://img.shields.io/npm/v/@xmcl/semver.svg)](https://www.npmjs.com/package/@xmcl/semver) |
| [@xmcl/bytebuffer](../packages/bytebuffer) | ByteBuffer teostus | [![npm](https://img.shields.io/npm/v/@xmcl/bytebuffer.svg)](https://www.npmjs.com/package/@xmcl/bytebuffer) |

## Panustamine

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Voxelum/x-minecraft-launcher)

Arendajatele: vaadake [Panustamise juhendit](CONTRIBUTING.et.md)

Tõlkijatele (i18n): vaadake [Lokaliseerimise alustamist](https://docs.xmcl.app/en/guide/i18n)
...
| [![](https://github.com/DGP-Studio/Snap.Hutao/assets/10614984/73ae8b90-f3c7-4033-b2b7-f4126331ce66)](https://signpath.io/) | Tasuta Windowsi koodiallkirjastamine: [SignPath.io](https://signpath.io/), sertifikaat: [SignPath Foundation](https://signpath.org/) |
| :---: | :---: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy) serverita JavaScripti rakendustele. Pakub [Deno](https://deno.com/) |
| [![](../assets/EdgeOne.png)](https://edgeone.ai/) | [Tencent EdgeOne](https://edgeone.ai/) — CDN kiirendus ja turvalisus Tencent EdgeOne toel. |
...
## Tänusõnad ja Autorid

### 🌍 Kogukond ja Lokaliseerimine

**[BANSAFAn/Baneronetwo](https://github.com/BANSAFAn)**
RU/UK kogukonna tugi ja modereerimine

**[Marmur2020](https://github.com/Marmur2020)**
Täielik ukrainakeelne tõlge

### Technologický Základ a Architektura

Přehled nástrojů použitých v projektu:

- [Node.js >=18.17.0](https://nodejs.org/): Běhové prostředí pro knihovny jádra.
- [Electron 27](https://electron.atom.io): Běhové prostředí desktopové aplikace.
- [pnpm](https://pnpm.io/): Správce balíčků monorepa.
- [TypeScript](https://www.typescriptlang.org/): Hlavní programovací jazyk projektu.
- [Vue & Vite](https://vuejs.org/): Uživatelské rozhraní a systém sestavení.

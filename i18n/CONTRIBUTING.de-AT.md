...
Übersicht über die im Projekt verwendeten Technologien:

- [Node.js >=18.17.0](https://nodejs.org/): Laufzeitumgebung der Kernbibliotheken.
- [Electron 27](https://electron.atom.io): Desktop-Anwendungslaufzeit.
- [pnpm](https://pnpm.io/): Monorepo-Paketmanager.
- [TypeScript](https://www.typescriptlang.org/): Hauptprogrammiersprache.
- [Vue & Vite](https://vuejs.org/): Benutzeroberfläche und Build-System.
...
1. **Projekt mit Submodulen klonen**:
   ```bash

...
Visão geral do ambiente e ferramentas deste projeto:

- [Node.js >=18.17.0](https://nodejs.org/): Ambiente de base para as bibliotecas do núcleo.
- [Electron 27](https://electron.atom.io): Motor de execução da aplicação.
- [pnpm](https://pnpm.io/): Gestão de pacotes no monorepo.
- [TypeScript](https://www.typescriptlang.org/): Utilizado em todo o código-fonte.
- [Vue & Vite](https://vuejs.org/): Construção e empacotamento da interface de utilizador.
...
3. **Iniciar o ambiente de desenvolvimento**:
   ...
   pnpm dev
   ```
4. **Verificar tipos e regras de código**:
   ```bash
   pnpm check
   pnpm lint
   ```

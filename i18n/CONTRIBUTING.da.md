### Teknologistak og Arkitektur

Oversigt over værktøjer og teknologier i projektet:

- [Node.js >=18.17.0](https://nodejs.org/): Grundlæggende kørselstidsmiljø for kernen.
- [Electron 27](https://electron.atom.io): Desktop-applikationens kørselstid.
- [pnpm](https://pnpm.io/): Pakkehåndtering for monorepoet.
- [TypeScript](https://www.typescriptlang.org/): Hovedsproget i hele projektet.
- [Vue & Vite](https://vuejs.org/): Brugergrænseflade og build-værktøj.
...
1. **Klon projektet med undermoduler**:
   ```bash

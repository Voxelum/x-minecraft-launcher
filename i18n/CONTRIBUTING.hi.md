### तकनीकी संरचना और परियोजना अवलोकन

परियोजना में उपयोग किए गए मुख्य उपकरण और तकनीकें:

- [Node.js >=18.17.0](https://nodejs.org/): मुख्य लाइब्रेरी का वातावरण।
- [Electron 27](https://electron.atom.io): लॉन्चर का डेस्कटॉप रनटाइम।
- [pnpm](https://pnpm.io/): पैकेज प्रबंधन उपकरण।
- [TypeScript](https://www.typescriptlang.org/): मुख्य प्रोग्रामिंग भाषा।
- [Vue & Vite](https://vuejs.org/): फ्रंट-एंड इंटरफ़ेस और बिल्ड टूल।
...
### योगदान कैसे शुरू करें

1. **सबमॉड्यूल के साथ क्लोन करें**:
   ```bash
...
2. **पैकेज इंस्टॉल करें**:
   ...
   pnpm install
   ```
3. **डेवलपमेंट मोड शुरू करें**:
   ```bash
   pnpm dev
   ```
4. **टाइप चेक और लिंटिंग**:
   ```bash
   pnpm check
   pnpm lint
   ```

...
Resumen de las herramientas y el entorno de ejecución de este proyecto:

- [Node.js >=18.17.0](https://nodejs.org/): Entorno base de las bibliotecas del núcleo.
- [Electron 27](https://electron.atom.io): Entorno de ejecución de la aplicación de escritorio.
- [pnpm](https://pnpm.io/): Gestor de paquetes del monorepositorio.
- [TypeScript](https://www.typescriptlang.org/): Lenguaje principal utilizado en todo el proyecto.
- [Vue & Vite](https://vuejs.org/): Interfaz de usuario y sistema de compilación.
...
1. **Clonar el proyecto con submódulos**:
   ```bash
...
3. **Iniciar el servidor de desarrollo**:
   ...
   pnpm dev
   ```
4. **Verificación de tipos y linting**:
   ```bash
   pnpm check
   pnpm lint
   ```

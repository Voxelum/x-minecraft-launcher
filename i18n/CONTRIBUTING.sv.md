...
Översikt över verktyg och teknik som används i projektet:

- [Node.js >=18.17.0](https://nodejs.org/): Grundläggande körtidsmiljö.
- [Electron 27](https://electron.atom.io): Skrivbordsapplikationens körtid.
- [pnpm](https://pnpm.io/): Pakethanterare för monorepot.
- [TypeScript](https://www.typescriptlang.org/): Huvudspråket i hela projektet.
- [Vue & Vite](https://vuejs.org/): Användargränssnitt och byggsystem.
...
### Kom Igång med Bidrag

1. **Klona projektet med undermoduler**:
   ```bash

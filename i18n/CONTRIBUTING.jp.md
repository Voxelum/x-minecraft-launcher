...
プロジェクトで使用されている主な技術とツール：

- [Node.js >=18.17.0](https://nodejs.org/): コアライブラリのベース環境。
- [Electron 27](https://electron.atom.io): デスクトップアプリの実行環境。
- [pnpm](https://pnpm.io/): モノレポパッケージマネージャー。
- [TypeScript](https://www.typescriptlang.org/): プロジェクト全体の主要言語。
- [Vue & Vite](https://vuejs.org/): ユーザーインターフェースとビルドツール。

...
Επισκόπηση των εργαλείων και τεχνολογιών του έργου:

- [Node.js >=18.17.0](https://nodejs.org/): Περιβάλλον εκτέλεσης βασικών βιβλιοθηκών.
- [Electron 27](https://electron.atom.io): Περιβάλλον εκτέλεσης επιτραπέζιας εφαρμογής.
- [pnpm](https://pnpm.io/): Διαχειριστής πακέτων monorepo.
- [TypeScript](https://www.typescriptlang.org/): Κύρια γλώσσα προγραμματισμού.
- [Vue & Vite](https://vuejs.org/): Διεπαφή χρήστη και σύστημα build.
...
2. **Εγκατάσταση εξαρτήσεων**:
   ...
   pnpm install
   ```
3. **Έναρξη λειτουργίας ανάπτυξης**:
   ```bash
   pnpm dev
   ```
4. **Έλεγχος τύπων και μορφοποίησης**:
   ```bash
   pnpm check
   pnpm lint
   ```

...
Наведайце [афіцыйны сайт](https://xmcl.app), каб спампаваць праграму!

Калі ў вас усталяваны winget, вы можаце выкарыстоўваць яго для ўсталёўкі:

```bash
winget install CI010.XMinecraftLauncher
```

Усталёўка праз Homebrew (macOS tap):
...
У Linux XMCL таксама даступны на Flathub:
...
- 📥 **Аўтаматычная загрузка і дапаўненне**. Падтрымка загрузкі `Minecraft`, `Forge`, `Fabric`, `Quilt`, `OptiFine`, `JVM` з афіцыйных і іншых люстэркаў.
- ⚡️ **Высокая хуткасць загрузкі**. Паўторнае выкарыстанне злучэнняў праз HTTP/HTTPS і шматструменная загрузка файлаў часткамі.
- 💻 **Кросплатформеннасць**. Лаўнчар пабудаваны на базе Electron і падтрымлівае 🗔 Windows 10/11, 🍎 macOS і 🐧 Linux.
- 📚 **Кіраванне некалькімі інстансамі**. Стварэнне ізаляваных профіляў для розных версій, модаў і налад запуску.
- 🗂 **Эфектыўнае кіраванне рэсурсамі**. Жорсткія і сімвалічныя спасылкі для ўсталёўкі модаў без дублявання файлаў і эканоміі месца на дыску! 😆
- 🔥 **Убудаваная падтрымка CurseForge і Modrinth**. Спампоўвайце моды і рэсурспакі наўпрост у лаўнчары.
- 📦 **Імпарт і экспарт модпакаў**. Поўная падтрымка стандартаў модпакаў CurseForge і Modrinth!
- 🔒 **Падтрымка некалькіх уліковых запісаў**. Уваход праз Microsoft, Mojang Yggdrasil API, [ely.by](https://ely.by/) і карыстальніцкія серверы аўтэнтыфікацыі!
- 🔗 **P2P мультыплэер**. Гуляйце з сябрамі па віртуальнай лакальнай сетцы праз інтэрнэт без складаных налад!
- 🔑 **Лічбавы подпіс і сучасныя пакеты**. У Windows падтрымліваюцца `appx` і `appinstaller` без папярэджанняў SmartScreen! 😎

## Асноўныя бібліятэкі ядра (Core Libraries)

Гэты рэпазітар таксама ўключае ў сябе **Minecraft Launcher Core** (пакеты `@xmcl/*`) — набор npm-пакетаў для стварэння лаўнчара Minecraft. [Дакументацыя API](https://docs.xmcl.app/en/core)
...
| [@xmcl/installer](../packages/installer) | Усталёўка Minecraft, Forge, Fabric, Quilt, OptiFine, JVM | [![npm](https://img.shields.io/npm/v/@xmcl/installer.svg)](https://www.npmjs.com/package/@xmcl/installer) |
| [@xmcl/user](../packages/user) | Аўтэнтыфікацыя карыстальнікаў і скіны | [![npm](https://img.shields.io/npm/v/@xmcl/user.svg)](https://www.npmjs.com/package/@xmcl/user) |
| [@xmcl/mod-parser](../packages/mod-parser) | Парсінг модаў Forge/LiteLoader/Fabric | [![npm](https://img.shields.io/npm/v/@xmcl/mod-parser.svg)](https://www.npmjs.com/package/@xmcl/mod-parser) |
...
| [@xmcl/nbt](../packages/nbt) | Парсінг NBT | [![npm](https://img.shields.io/npm/v/@xmcl/nbt.svg)](https://www.npmjs.com/package/@xmcl/nbt) |
| [@xmcl/game-data](../packages/game-data) | Загрузка дадзеных узроўняў або servers.dat | [![npm](https://img.shields.io/npm/v/@xmcl/game-data.svg)](https://www.npmjs.com/package/@xmcl/game-data) |
| [@xmcl/resourcepack](../packages/resourcepack) | Парсінг рэсурспакаў | [![npm](https://img.shields.io/npm/v/@xmcl/resourcepack.svg)](https://www.npmjs.com/package/@xmcl/resourcepack) |
| [@xmcl/gamesetting](../packages/gamesetting) | Парсінг налад гульні | [![npm](https://img.shields.io/npm/v/@xmcl/gamesetting.svg)](https://www.npmjs.com/package/@xmcl/gamesetting) |
| [@xmcl/client](../packages/client) | Сеткавыя ўтыліты кліента Minecraft | [![npm](https://img.shields.io/npm/v/@xmcl/client.svg)](https://www.npmjs.com/package/@xmcl/client) |
| [@xmcl/model](../packages/model) | Адлюстраванне 3D-мадэляў гульцоў і блокаў | [![npm](https://img.shields.io/npm/v/@xmcl/model.svg)](https://www.npmjs.com/package/@xmcl/model) |
| [@xmcl/text-component](../packages/text-component) | Парсінг тэкставых кампанентаў Minecraft | [![npm](https://img.shields.io/npm/v/@xmcl/text-component.svg)](https://www.npmjs.com/package/@xmcl/text-component) |
| [@xmcl/forge-site-parser](../packages/forge-site-parser) | Парсінг сайта Forge | [![npm](https://img.shields.io/npm/v/@xmcl/forge-site-parser.svg)](https://www.npmjs.com/package/@xmcl/forge-site-parser) |
| [@xmcl/file-transfer](../packages/file-transfer) | Высокапрадукцыйная загрузка файлаў | [![npm](https://img.shields.io/npm/v/@xmcl/file-transfer.svg)](https://www.npmjs.com/package/@xmcl/file-transfer) |
| [@xmcl/nat-api](../packages/nat-api) | Пракіданне партоў UPnP і NAT-PMP | [![npm](https://img.shields.io/npm/v/@xmcl/nat-api.svg)](https://www.npmjs.com/package/@xmcl/nat-api) |
| [@xmcl/system](../packages/system) | FS middleware для браўзера/Node | [![npm](https://img.shields.io/npm/v/@xmcl/system.svg)](https://www.npmjs.com/package/@xmcl/system) |
| [@xmcl/unzip](../packages/unzip) | Абгортка распакавання zip (yauzl) | [![npm](https://img.shields.io/npm/v/@xmcl/unzip.svg)](https://www.npmjs.com/package/@xmcl/unzip) |
| [@xmcl/semver](../packages/semver) | Фармат Fabric semver | [![npm](https://img.shields.io/npm/v/@xmcl/semver.svg)](https://www.npmjs.com/package/@xmcl/semver) |
| [@xmcl/bytebuffer](../packages/bytebuffer) | Рэалізацыя ByteBuffer | [![npm](https://img.shields.io/npm/v/@xmcl/bytebuffer.svg)](https://www.npmjs.com/package/@xmcl/bytebuffer) |

## Удзел у распрацоўцы

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Voxelum/x-minecraft-launcher)

Для распрацоўшчыкаў: глядзіце [Кіраўніцтва па ўдзеле](CONTRIBUTING.be.md)

Для перакладчыкаў (i18n): глядзіце [Пачатак працы з лакалізацыяй](https://docs.xmcl.app/en/guide/i18n)
...
| [![](https://github.com/DGP-Studio/Snap.Hutao/assets/10614984/73ae8b90-f3c7-4033-b2b7-f4126331ce66)](https://signpath.io/) | Бясплатны лічбавы подпіс для Windows ад [SignPath.io](https://signpath.io/), сертыфікат ад [SignPath Foundation](https://signpath.org/) |
| :---: | :---: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy) для serverless JavaScript дадаткаў. Прадастаўлена [Deno](https://deno.com/) |
| [![](../assets/EdgeOne.png)](https://edgeone.ai/) | [Tencent EdgeOne](https://edgeone.ai/) — CDN і абарона спансіруюцца Tencent EdgeOne. |

...
Επισκεφθείτε την [επίσημη ιστοσελίδα](https://xmcl.app) για να κατεβάσετε την εφαρμογή!

Εάν έχετε εγκατεστημένο το winget:

```bash
winget install CI010.XMinecraftLauncher
```

Εγκατάσταση μέσω Homebrew (macOS tap):
...
Στο Linux, το XMCL είναι επίσης διαθέσιμο στο Flathub:
...
- 📥 **Αυτόματη λήψη και συμπλήρωση**. Υποστήριξη λήψης `Minecraft`, `Forge`, `Fabric`, `Quilt`, `OptiFine`, `JVM` από επίσημους ή τρίτους διακομιστές.
- ⚡️ **Γρήγορη λήψη**. Επαναχρησιμοποίηση συνδέσεων μέσω HTTP/HTTPS και παράλληλη λήψη αρχείων σε τμήματα.
- 💻 **Πολυπλατφορμικό**. Βασισμένο στο Electron, υποστηρίζει 🗔 Windows 10/11, 🍎 macOS και 🐧 Linux.
- 📚 **Διαχείριση πολλαπλών προφίλ**. Δημιουργήστε ξεχωριστά προφίλ για διαφορετικές εκδόσεις, mods και ρυθμίσεις.
- 🗂 **Έξυπνη διαχείριση πόρων**. Χρήση hard και symbolic links για εξοικονόμηση χώρου χωρίς διπλότυπα αρχεία! 😆
- 🔥 **Ενσωμάτωση CurseForge & Modrinth**. Αναζητήστε και κατεβάστε mods απευθείας μέσα από τον launcher.
- 📦 **Εισαγωγή/Εξαγωγή modpacks**. Πλήρης συμβατότητα με τα πρότυπα CurseForge και Modrinth!
- 🔒 **Υποστήριξη πολλαπλών λογαριασμών**. Σύνδεση Microsoft, Mojang Yggdrasil API, [ely.by](https://ely.by/) και προσαρμοσμένοι διακομιστές!
- 🔗 **P2P Multiplayer**. Παίξτε με φίλους μέσω εικονικού LAN στο διαδίκτυο χωρίς περίπλοκες ρυθμίσεις!
- 🔑 **Ψηφιακή υπογραφή & σύγχρονα πακέτα**. Στα Windows υποστηρίζονται `appx` και `appinstaller` χωρίς προειδοποιήσεις SmartScreen! 😎

## Βασικές Βιβλιοθήκες (Core Libraries)

Αυτό το αποθετήριο περιλαμβάνει επίσης το **Minecraft Launcher Core** (πακέτα `@xmcl/*`) — πακέτα npm για τη δημιουργία launchers Minecraft. [Τεκμηρίωση API](https://docs.xmcl.app/en/core)

| Package | Description | Version |
| --- | --- | --- |
| [@xmcl/core](../packages/core) | Εκκίνηση του Minecraft | [![npm](https://img.shields.io/npm/v/@xmcl/core.svg)](https://www.npmjs.com/package/@xmcl/core) |
| [@xmcl/installer](../packages/installer) | Εγκατάσταση Minecraft, Forge, Fabric, Quilt, OptiFine, JVM | [![npm](https://img.shields.io/npm/v/@xmcl/installer.svg)](https://www.npmjs.com/package/@xmcl/installer) |
| [@xmcl/user](../packages/user) | Ταυτοποίηση χρηστών και skins | [![npm](https://img.shields.io/npm/v/@xmcl/user.svg)](https://www.npmjs.com/package/@xmcl/user) |
| [@xmcl/mod-parser](../packages/mod-parser) | Ανάλυση mods Forge/LiteLoader/Fabric | [![npm](https://img.shields.io/npm/v/@xmcl/mod-parser.svg)](https://www.npmjs.com/package/@xmcl/mod-parser) |
...
| [@xmcl/nbt](../packages/nbt) | Ανάλυση δεδομένων NBT | [![npm](https://img.shields.io/npm/v/@xmcl/nbt.svg)](https://www.npmjs.com/package/@xmcl/nbt) |
| [@xmcl/game-data](../packages/game-data) | Φόρτωση δεδομένων κόσμου ή servers.dat | [![npm](https://img.shields.io/npm/v/@xmcl/game-data.svg)](https://www.npmjs.com/package/@xmcl/game-data) |
| [@xmcl/resourcepack](../packages/resourcepack) | Ανάλυση πακέτων πόρων (resource packs) | [![npm](https://img.shields.io/npm/v/@xmcl/resourcepack.svg)](https://www.npmjs.com/package/@xmcl/resourcepack) |
| [@xmcl/gamesetting](../packages/gamesetting) | Ανάλυση ρυθμίσεων παιχνιδιού | [![npm](https://img.shields.io/npm/v/@xmcl/gamesetting.svg)](https://www.npmjs.com/package/@xmcl/gamesetting) |
| [@xmcl/client](../packages/client) | Εργαλεία δικτύου για τον πελάτη Minecraft | [![npm](https://img.shields.io/npm/v/@xmcl/client.svg)](https://www.npmjs.com/package/@xmcl/client) |
| [@xmcl/model](../packages/model) | Απόδοση 3D μοντέλων παικτών και κύβων | [![npm](https://img.shields.io/npm/v/@xmcl/model.svg)](https://www.npmjs.com/package/@xmcl/model) |
| [@xmcl/text-component](../packages/text-component) | Ανάλυση στοιχείων κειμένου Minecraft | [![npm](https://img.shields.io/npm/v/@xmcl/text-component.svg)](https://www.npmjs.com/package/@xmcl/text-component) |
| [@xmcl/forge-site-parser](../packages/forge-site-parser) | Ανάλυση ιστοσελίδας Forge | [![npm](https://img.shields.io/npm/v/@xmcl/forge-site-parser.svg)](https://www.npmjs.com/package/@xmcl/forge-site-parser) |
| [@xmcl/file-transfer](../packages/file-transfer) | Λήψη αρχείων υψηλής απόδοσης | [![npm](https://img.shields.io/npm/v/@xmcl/file-transfer.svg)](https://www.npmjs.com/package/@xmcl/file-transfer) |
| [@xmcl/nat-api](../packages/nat-api) | Αντιστοίχιση θυρών UPnP και NAT-PMP | [![npm](https://img.shields.io/npm/v/@xmcl/nat-api.svg)](https://www.npmjs.com/package/@xmcl/nat-api) |
| [@xmcl/system](../packages/system) | FS middleware για browser/Node | [![npm](https://img.shields.io/npm/v/@xmcl/system.svg)](https://www.npmjs.com/package/@xmcl/system) |
| [@xmcl/unzip](../packages/unzip) | Wrapper αποσυμπίεσης zip (yauzl) | [![npm](https://img.shields.io/npm/v/@xmcl/unzip.svg)](https://www.npmjs.com/package/@xmcl/unzip) |
| [@xmcl/semver](../packages/semver) | Μορφή Fabric semver | [![npm](https://img.shields.io/npm/v/@xmcl/semver.svg)](https://www.npmjs.com/package/@xmcl/semver) |
| [@xmcl/bytebuffer](../packages/bytebuffer) | Υλοποίηση ByteBuffer | [![npm](https://img.shields.io/npm/v/@xmcl/bytebuffer.svg)](https://www.npmjs.com/package/@xmcl/bytebuffer) |

## Συνεισφορά

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Voxelum/x-minecraft-launcher)

Για προγραμματιστές: δείτε τον [Οδηγό Συνεισφοράς](CONTRIBUTING.el.md)

Για μεταφραστές (i18n): δείτε τον [Οδηγό Τοπικοποίησης](https://docs.xmcl.app/en/guide/i18n)
...
| [![](https://github.com/DGP-Studio/Snap.Hutao/assets/10614984/73ae8b90-f3c7-4033-b2b7-f4126331ce66)](https://signpath.io/) | Δωρεάν υπογραφή κώδικα Windows από [SignPath.io](https://signpath.io/), πιστοποιητικό από [SignPath Foundation](https://signpath.org/) |
| :---: | :---: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy) για serverless εφαρμογές JavaScript. Παρέχεται από [Deno](https://deno.com/) |
| [![](../assets/EdgeOne.png)](https://edgeone.ai/) | [Tencent EdgeOne](https://edgeone.ai/) — Επιτάχυνση CDN και ασφάλεια με χορηγία από Tencent EdgeOne. |
...
## Ευχαριστίες και Συντελεστές

### 🌍 Κοινότητα & Τοπικοποίηση

**[BANSAFAn/Baneronetwo](https://github.com/BANSAFAn)**
Υποστήριξη και εποπτεία κοινότητας RU/UK

**[Marmur2020](https://github.com/Marmur2020)**
Πλήρης μετάφραση στα ουκρανικά
...
Συντήρηση πακέτου AUR (Arch User Repository)

**[0xc0000142](https://github.com/0xc0000142)**
Συντήρηση πακέτου winget

### 🛠️ Προγραμματιστές

**[lukechu10](https://github.com/lukechu10) & [HoldYourWaffle](https://github.com/HoldYourWaffle)**
Ανάπτυξη πυρήνα launcher

**[laolarou726](https://github.com/laolarou726)**
Σχεδιασμός διεπαφής και UI/UX

### 💙 Ιδιαίτερες Ευχαριστίες

Ευχαριστούμε θερμά για την υποστήριξη και τη συνεισφορά:

...
Vieraile [virallisella sivustolla](https://xmcl.app) ladataksesi sovelluksen!

Jos sinulla on winget asennettuna, voit käyttää komentoa:

```bash
winget install CI010.XMinecraftLauncher
```

Asennus Homebrewn kautta (macOS tap):
...
Linuxissa XMCL on saatavilla myös Flathubissa:
...
- 📥 **Automaattinen lataus & täydennys**. Tuki `Minecraft`, `Forge`, `Fabric`, `Quilt`, `OptiFine`, `JVM` latauksille.
- ⚡️ **Huippunopea lataus**. Yhteyksien uudelleenkäyttö ja tiedostojen rinnakkainen monisäikeinen lataus.
- 💻 **Monialustainen**. Electron-pohjainen ja tukee 🗔 Windows 10/11, 🍎 macOS ja 🐧 Linux -järjestelmiä.
- 📚 **Monen instanssin hallinta**. Luo erillisiä profiileja peliversioille, modeille ja asetuksille.
- 🗂 **Älykäs resurssienhallinta**. Käyttää kovia ja symbolisia linkkejä levytilan säästämiseksi ilman tiedostojen kopiointia! 😆
- 🔥 **Sisäänrakennettu CurseForge & Modrinth**. Etsi ja asenna resurssit suoraan käynnistimessä.
- 📦 **Modipakettien tuonti ja vienti**. Täysi yhteensopivuus CurseForge- ja Modrinth-standardien kanssa!
- 🔒 **Monen käyttäjätilin tuki**. Microsoft-kirjautuminen, Mojang Yggdrasil API, [ely.by](https://ely.by/) ja mukautetut palvelimet!
- 🔗 **P2P-moninpeli**. Pelaa ystävien kanssa virtuaalisessa lähiverkossa ilman monimutkaisia asetuksia!
- 🔑 **Koodiallekirjoitus ja modernit paketit**. Windowsissa `appx` ja `appinstaller` toimivat ilman SmartScreen-varoituksia! 😎

## Ydinkirjastot (Core Libraries)

Tämä arkisto sisältää myös **Minecraft Launcher Core** (`@xmcl/*` paketit) npm-kirjastot Minecraft-käynnistimen rakentamiseen. [API Dokumentaatio](https://docs.xmcl.app/en/core)

| Package | Description | Version |
| --- | --- | --- |
| [@xmcl/core](../packages/core) | Käynnistä Minecraft | [![npm](https://img.shields.io/npm/v/@xmcl/core.svg)](https://www.npmjs.com/package/@xmcl/core) |
| [@xmcl/installer](../packages/installer) | Asenna Minecraft, Forge, Fabric, Quilt, OptiFine, JVM | [![npm](https://img.shields.io/npm/v/@xmcl/installer.svg)](https://www.npmjs.com/package/@xmcl/installer) |
| [@xmcl/user](../packages/user) | Käyttäjätunnistus ja ulkoasut | [![npm](https://img.shields.io/npm/v/@xmcl/user.svg)](https://www.npmjs.com/package/@xmcl/user) |
| [@xmcl/mod-parser](../packages/mod-parser) | Analysoi Forge/LiteLoader/Fabric modit | [![npm](https://img.shields.io/npm/v/@xmcl/mod-parser.svg)](https://www.npmjs.com/package/@xmcl/mod-parser) |
...
| [@xmcl/nbt](../packages/nbt) | Analysoi NBT-tiedot | [![npm](https://img.shields.io/npm/v/@xmcl/nbt.svg)](https://www.npmjs.com/package/@xmcl/nbt) |
| [@xmcl/game-data](../packages/game-data) | Lataa maailmatiedot tai servers.dat | [![npm](https://img.shields.io/npm/v/@xmcl/game-data.svg)](https://www.npmjs.com/package/@xmcl/game-data) |
| [@xmcl/resourcepack](../packages/resourcepack) | Analysoi resurssipaketit | [![npm](https://img.shields.io/npm/v/@xmcl/resourcepack.svg)](https://www.npmjs.com/package/@xmcl/resourcepack) |
| [@xmcl/gamesetting](../packages/gamesetting) | Analysoi peliasetukset | [![npm](https://img.shields.io/npm/v/@xmcl/gamesetting.svg)](https://www.npmjs.com/package/@xmcl/gamesetting) |
| [@xmcl/client](../packages/client) | Minecraft-asiakkaan verkkotyökalut | [![npm](https://img.shields.io/npm/v/@xmcl/client.svg)](https://www.npmjs.com/package/@xmcl/client) |
| [@xmcl/model](../packages/model) | Näytä pelaajien ja lohkojen 3D-mallit | [![npm](https://img.shields.io/npm/v/@xmcl/model.svg)](https://www.npmjs.com/package/@xmcl/model) |
| [@xmcl/text-component](../packages/text-component) | Analysoi Minecraft-tekstikomponentit | [![npm](https://img.shields.io/npm/v/@xmcl/text-component.svg)](https://www.npmjs.com/package/@xmcl/text-component) |
| [@xmcl/forge-site-parser](../packages/forge-site-parser) | Analysoi Forge-verkkosivusto | [![npm](https://img.shields.io/npm/v/@xmcl/forge-site-parser.svg)](https://www.npmjs.com/package/@xmcl/forge-site-parser) |
| [@xmcl/file-transfer](../packages/file-transfer) | Huippunopea tiedostojen lataus | [![npm](https://img.shields.io/npm/v/@xmcl/file-transfer.svg)](https://www.npmjs.com/package/@xmcl/file-transfer) |
| [@xmcl/nat-api](../packages/nat-api) | UPnP- ja NAT-PMP-porttiohjaukset | [![npm](https://img.shields.io/npm/v/@xmcl/nat-api.svg)](https://www.npmjs.com/package/@xmcl/nat-api) |
| [@xmcl/system](../packages/system) | FS-väliohjelmisto selaimelle/Nodelle | [![npm](https://img.shields.io/npm/v/@xmcl/system.svg)](https://www.npmjs.com/package/@xmcl/system) |
| [@xmcl/unzip](../packages/unzip) | yauzl zip-purkamiskääre | [![npm](https://img.shields.io/npm/v/@xmcl/unzip.svg)](https://www.npmjs.com/package/@xmcl/unzip) |
| [@xmcl/semver](../packages/semver) | Fabric semver -muotoilu | [![npm](https://img.shields.io/npm/v/@xmcl/semver.svg)](https://www.npmjs.com/package/@xmcl/semver) |
| [@xmcl/bytebuffer](../packages/bytebuffer) | ByteBuffer-toteutus | [![npm](https://img.shields.io/npm/v/@xmcl/bytebuffer.svg)](https://www.npmjs.com/package/@xmcl/bytebuffer) |

## Osallistu kehitykseen

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Voxelum/x-minecraft-launcher)

Kehittäjille: katso [Osallistumisopas](CONTRIBUTING.fi.md)

Kääntäjille (i18n): katso [Lokalisoinnin aloitus](https://docs.xmcl.app/en/guide/i18n)
...
| [![](https://github.com/DGP-Studio/Snap.Hutao/assets/10614984/73ae8b90-f3c7-4033-b2b7-f4126331ce66)](https://signpath.io/) | Ilmaisen Windows-koodiallekirjoituksen tarjoaa [SignPath.io](https://signpath.io/), sertifikaatti [SignPath Foundation](https://signpath.org/) |
| :---: | :---: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy) palvelimettomille JavaScript-sovelluksille. Tarjoaa [Deno](https://deno.com/) |
| [![](../assets/EdgeOne.png)](https://edgeone.ai/) | [Tencent EdgeOne](https://edgeone.ai/) — CDN-kiihdytyksen ja suojauksen sponsoroi Tencent EdgeOne. |
...
## Kiitokset ja tekijät

### 🌍 Yhteisö ja lokalisointi

**[BANSAFAn/Baneronetwo](https://github.com/BANSAFAn)**
RU/UK-yhteisön tuki ja moderointi

**[Marmur2020](https://github.com/Marmur2020)**
Täydellinen ukrainankielinen käännös
...
AUR-paketin ylläpito (Arch User Repository)

**[0xc0000142](https://github.com/0xc0000142)**
winget-paketin ylläpito

### 🛠️ Kehittäjät

**[lukechu10](https://github.com/lukechu10) & [HoldYourWaffle](https://github.com/HoldYourWaffle)**
Käynnistimen ytimen kehitys

**[laolarou726](https://github.com/laolarou726)**
Käyttöliittymän suunnittelu ja UI/UX

### 💙 Erityiskiitokset

Lämmin kiitos näille henkilöille heidän tuestaan ja panoksestaan:

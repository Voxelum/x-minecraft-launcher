### التقنيات المستخدمة وبنية المشروع

نظرة عامة على بيئة العمل وأدوات التطوير في المشروع:

- [Node.js >=18.17.0](https://nodejs.org/): بيئة التشغيل الأساسية لمكتبات النواة.
- [Electron 27](https://electron.atom.io): بيئة تشغيل المشغل لسطح المكتب.
- [pnpm](https://pnpm.io/): لإدارة الحزم في المستودع الموحد (monorepo).
- [TypeScript](https://www.typescriptlang.org/): مستخدم في كافة أجزاء المشروع.
- [Vue & Vite](https://vuejs.org/): لبناء واجهة المستخدم وتجميعها.

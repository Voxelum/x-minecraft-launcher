### Tehnoloogiad ja arhitektuur

Ülevaade projektis kasutatavatest tööriistadest ja keskkonnast:

- [Node.js >=18.17.0](https://nodejs.org/): Tuumikteekide käitusaeg.
- [Electron 27](https://electron.atom.io): Töölauarakenduse platvorm.
- [pnpm](https://pnpm.io/): Monorepo paketihaldur.
- [TypeScript](https://www.typescriptlang.org/): Peamine programmeerimiskeel.
- [Vue & Vite](https://vuejs.org/): Kasutajaliides ja ehitussüsteem.
...
1. **Klooni projekt koos alamoodulitega**:
   ```bash
...
2. **Paigalda sõltuvused**:
   ...
   pnpm install
   ```
3. **Käivita arendusrežiim**:
   ```bash
   pnpm dev
   ```
4. **Tüübi- ja koodikontroll**:
   ```bash
   pnpm check
   pnpm lint
   ```

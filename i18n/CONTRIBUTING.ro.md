...
Prezentare generală a tehnologiilor utilizate în proiect:

- [Node.js >=18.17.0](https://nodejs.org/): Mediul de execuție pentru bibliotecile de bază.
- [Electron 27](https://electron.atom.io): Mediul de execuție al aplicației desktop.
- [pnpm](https://pnpm.io/): Managerul de pachete monorepo.
- [TypeScript](https://www.typescriptlang.org/): Limbajul principal utilizat.
- [Vue & Vite](https://vuejs.org/): Interfața cu utilizatorul și sistemul de build.
...
3. **Pornire server de dezvoltare**:
   ...
   pnpm dev
   ```
4. **Verificare tipuri și linting**:
   ```bash
   pnpm check
   pnpm lint
   ```

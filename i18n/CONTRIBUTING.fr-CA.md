...
Aperçu des technologies utilisées pour le développement du projet :

- [Node.js >=18.17.0](https://nodejs.org/) : Environnement d'exécution pour les modules principaux.
- [Electron 27](https://electron.atom.io) : Moteur d'exécution pour l'application de bureau.
- [pnpm](https://pnpm.io/) : Gestionnaire de paquets pour le monorepo.
- [TypeScript](https://www.typescriptlang.org/) : Langage utilisé pour l'ensemble du projet.
- [Vue & Vite](https://vuejs.org/) : Développement de l'interface utilisateur.
...
3. **Lancer le serveur de développement** :
   ...
   pnpm dev
   ```
4. **Valider les types et le lint** :
   ```bash
   pnpm check
   pnpm lint
   ```

...
A projektben használt főbb eszközök és technológiák:

- [Node.js >=18.17.0](https://nodejs.org/): A fő függvénykönyvtárak futtatókörnyezete.
- [Electron 27](https://electron.atom.io): Asztali alkalmazás futtatókörnyezete.
- [pnpm](https://pnpm.io/): Monorepo csomagkezelő.
- [TypeScript](https://www.typescriptlang.org/): A projekt elsődleges nyelve.
- [Vue & Vite](https://vuejs.org/): Felhasználói felület és építőrendszer.
...
1. **Klónozás almodulokkal együtt**:
   ```bash

...
Visita il [sito ufficiale](https://xmcl.app) per scaricare l'applicazione!

Se hai winget installato, puoi utilizzarlo per installare:

```bash
winget install CI010.XMinecraftLauncher
```

Installazione tramite Homebrew (macOS tap):
...
Su Linux, XMCL è disponibile anche su Flathub:
...
- 📥 **Download e completamento automatico**. Supporta il download di `Minecraft`, `Forge`, `Fabric`, `Quilt`, `OptiFine`, `JVM` da mirror ufficiali o di terze parti.
- ⚡️ **Download ad alta velocità**. Riuso dei socket tramite agenti HTTP/HTTPS e download parallelo a blocchi.
- 💻 **Multipiattaforma**. Basato su Electron con supporto completo per 🗔 Windows 10/11, 🍎 macOS e 🐧 Linux.
- 📚 **Gestione multi-istanza**. Crea istanze isolate per separare versioni di gioco, mod e impostazioni di avvio.
- 🗂 **Gestione efficiente delle risorse**. Utilizza hard link e link simbolici per installare mod senza duplicare i file, risparmiando spazio su disco! 😆
- 🔥 **Integrazione CurseForge & Modrinth**. Cerca e scarica mod e pacchetti di risorse direttamente dal launcher.
- 📦 **Importazione ed esportazione di modpack**. Piena conformità con i formati ufficiali di CurseForge e Modrinth!
- 🔒 **Supporto per account multipli**. Accesso ufficiale Microsoft, Mojang Yggdrasil API, [ely.by](https://ely.by/) e server di autenticazione personalizzati!
- 🔗 **Multigiocatore P2P**. Gioca con gli amici tramite LAN virtuale su Internet senza complesse configurazioni di rete!
- 🔑 **Firma digitale e pacchetti moderni**. Su Windows supporta `appx` e `appinstaller` senza avvisi di SmartScreen! 😎

## Librerie principali (Core Libraries)

Questo repository include anche il **Minecraft Launcher Core** (pacchetti `@xmcl/*`) — un insieme di pacchetti npm per creare launcher di Minecraft. [Documentazione API](https://docs.xmcl.app/en/core)

| Package | Description | Version |
| --- | --- | --- |
| [@xmcl/core](../packages/core) | Avvio di Minecraft | [![npm](https://img.shields.io/npm/v/@xmcl/core.svg)](https://www.npmjs.com/package/@xmcl/core) |
| [@xmcl/installer](../packages/installer) | Installazione di Minecraft, Forge, Fabric, Quilt, OptiFine, JVM | [![npm](https://img.shields.io/npm/v/@xmcl/installer.svg)](https://www.npmjs.com/package/@xmcl/installer) |
| [@xmcl/user](../packages/user) | Autenticazione utente e skin | [![npm](https://img.shields.io/npm/v/@xmcl/user.svg)](https://www.npmjs.com/package/@xmcl/user) |
| [@xmcl/mod-parser](../packages/mod-parser) | Parsing di mod Forge/LiteLoader/Fabric | [![npm](https://img.shields.io/npm/v/@xmcl/mod-parser.svg)](https://www.npmjs.com/package/@xmcl/mod-parser) |
...
| [@xmcl/nbt](../packages/nbt) | Parsing NBT | [![npm](https://img.shields.io/npm/v/@xmcl/nbt.svg)](https://www.npmjs.com/package/@xmcl/nbt) |
| [@xmcl/game-data](../packages/game-data) | Caricamento dati di livello o servers.dat | [![npm](https://img.shields.io/npm/v/@xmcl/game-data.svg)](https://www.npmjs.com/package/@xmcl/game-data) |
| [@xmcl/resourcepack](../packages/resourcepack) | Parsing di resource pack | [![npm](https://img.shields.io/npm/v/@xmcl/resourcepack.svg)](https://www.npmjs.com/package/@xmcl/resourcepack) |
| [@xmcl/gamesetting](../packages/gamesetting) | Parsing impostazioni di gioco | [![npm](https://img.shields.io/npm/v/@xmcl/gamesetting.svg)](https://www.npmjs.com/package/@xmcl/gamesetting) |
| [@xmcl/client](../packages/client) | Utility di rete client Minecraft | [![npm](https://img.shields.io/npm/v/@xmcl/client.svg)](https://www.npmjs.com/package/@xmcl/client) |
| [@xmcl/model](../packages/model) | Rendering modelli 3D di giocatori e blocchi | [![npm](https://img.shields.io/npm/v/@xmcl/model.svg)](https://www.npmjs.com/package/@xmcl/model) |
| [@xmcl/text-component](../packages/text-component) | Parsing componenti di testo Minecraft | [![npm](https://img.shields.io/npm/v/@xmcl/text-component.svg)](https://www.npmjs.com/package/@xmcl/text-component) |
| [@xmcl/forge-site-parser](../packages/forge-site-parser) | Parsing del sito Forge | [![npm](https://img.shields.io/npm/v/@xmcl/forge-site-parser.svg)](https://www.npmjs.com/package/@xmcl/forge-site-parser) |
| [@xmcl/file-transfer](../packages/file-transfer) | Download di file ad alte prestazioni | [![npm](https://img.shields.io/npm/v/@xmcl/file-transfer.svg)](https://www.npmjs.com/package/@xmcl/file-transfer) |
| [@xmcl/nat-api](../packages/nat-api) | Mappatura porte UPnP e NAT-PMP | [![npm](https://img.shields.io/npm/v/@xmcl/nat-api.svg)](https://www.npmjs.com/package/@xmcl/nat-api) |
| [@xmcl/system](../packages/system) | Middleware FS per browser/Node | [![npm](https://img.shields.io/npm/v/@xmcl/system.svg)](https://www.npmjs.com/package/@xmcl/system) |
| [@xmcl/unzip](../packages/unzip) | Wrapper per decompressione zip yauzl | [![npm](https://img.shields.io/npm/v/@xmcl/unzip.svg)](https://www.npmjs.com/package/@xmcl/unzip) |
| [@xmcl/semver](../packages/semver) | Formato Fabric semver | [![npm](https://img.shields.io/npm/v/@xmcl/semver.svg)](https://www.npmjs.com/package/@xmcl/semver) |
| [@xmcl/bytebuffer](../packages/bytebuffer) | Implementazione ByteBuffer | [![npm](https://img.shields.io/npm/v/@xmcl/bytebuffer.svg)](https://www.npmjs.com/package/@xmcl/bytebuffer) |

## Contribuisci

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Voxelum/x-minecraft-launcher)

Per sviluppatori: consulta la [Guida ai contributi](CONTRIBUTING.it.md)

Per traduttori (i18n): consulta la [Guida alla localizzazione](https://docs.xmcl.app/en/guide/i18n)
...
| [![](https://github.com/DGP-Studio/Snap.Hutao/assets/10614984/73ae8b90-f3c7-4033-b2b7-f4126331ce66)](https://signpath.io/) | Firma del codice gratuita su Windows fornita da [SignPath.io](https://signpath.io/), certificato da [SignPath Foundation](https://signpath.org/) |
| :---: | :---: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy) per applicazioni JavaScript serverless. Fornito da [Deno](https://deno.com/) |
| [![](../assets/EdgeOne.png)](https://edgeone.ai/) | [Tencent EdgeOne](https://edgeone.ai/) — Accelerazione CDN e sicurezza sponsorizzate da Tencent EdgeOne. |
...
### 🌍 Comunità e Localizzazione

**[BANSAFAn/Baneronetwo](https://github.com/BANSAFAn)**
Supporto e moderazione della comunità RU/UK

**[Marmur2020](https://github.com/Marmur2020)**
Traduzione completa in ucraino
...
Manutenzione pacchetto AUR (Arch User Repository)

**[0xc0000142](https://github.com/0xc0000142)**
Manutenzione pacchetto winget

### 🛠️ Sviluppatori

**[lukechu10](https://github.com/lukechu10) & [HoldYourWaffle](https://github.com/HoldYourWaffle)**
Sviluppo del motore principale del launcher

**[laolarou726](https://github.com/laolarou726)**
Design e UI/UX del launcher

### 💙 Ringraziamenti speciali

Un sincero ringraziamento a queste persone per il loro supporto e contributo:

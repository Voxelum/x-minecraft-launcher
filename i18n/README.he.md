...
בקרו ב[אתר הרשמי](https://xmcl.app) כדי להוריד את האפליקציה!

אם מותקן אצלכם winget, ניתן להתקין באמצעות:

```bash
winget install CI010.XMinecraftLauncher
```

התקנה דרך Homebrew (macOS tap):
...
ב-Linux, XMCL זמין גם ב-Flathub:
...
- 📥 **הורדה והשלמה אוטומטית**. תמיכה בהורדת `Minecraft`, `Forge`, `Fabric`, `Quilt`, `OptiFine`, `JVM` ממקורות רשמיים ומראות.
- ⚡️ **הורדה במהירות גבוהה**. שימוש חוזר בחיבורים והורדה מרובת מקטעים במקביל.
- 💻 **חוצה פלטפורמות**. מבוסס Electron ותומך ב-🗔 Windows 10/11, 🍎 macOS ו-🐧 Linux.
- 📚 **ניהול ריבוי פרופילים**. יצירת פרופילים מבודדים לגרסאות משחק, מודים והגדרות הפעלה שונות.
- 🗂 **ניהול משאבים חכם**. שימוש בקישורים קשיחים וסמליים לחסכון במקום בדיסק ללא שכפול קבצים! 😆
- 🔥 **שילוב מובנה של CurseForge & Modrinth**. חיפוש והורדת מודים וחבילות משאבים ישירות בלאנצ'ר.
- 📦 **ייבוא וייצוא חבילות מודים**. תאימות מלאה לתקני CurseForge ו-Modrinth!
- 🔒 **תמיכה במערכות חשבונות מרובות**. כניסת Microsoft, ממשק Mojang Yggdrasil, [ely.by](https://ely.by/) ושרתים מותאמים אישית!
- 🔗 **משחק מרובה משתתפים P2P**. שחקו עם חברים ברשת מקומית וירטואלית דרך האינטרנט ללא הגדרות רשת מסובכות!
- 🔑 **חתימת קוד וחבילות מודרניות**. תמיכה ב-`appx` ו-`appinstaller` ב-Windows ללא אזהרות SmartScreen! 😎

## ספריות ליבה (Core Libraries)

מאגר זה כולל גם את **Minecraft Launcher Core** (חבילות `@xmcl/*`) — אוסף חבילות npm לבניית לאנצ'רים למיינקראפט. [תיעוד API](https://docs.xmcl.app/en/core)

| Package | Description | Version |
| --- | --- | --- |
| [@xmcl/core](../packages/core) | הפעלת Minecraft | [![npm](https://img.shields.io/npm/v/@xmcl/core.svg)](https://www.npmjs.com/package/@xmcl/core) |
| [@xmcl/installer](../packages/installer) | התקנת Minecraft, Forge, Fabric, Quilt, OptiFine, JVM | [![npm](https://img.shields.io/npm/v/@xmcl/installer.svg)](https://www.npmjs.com/package/@xmcl/installer) |
| [@xmcl/user](../packages/user) | אימות משתמשים וסקינים | [![npm](https://img.shields.io/npm/v/@xmcl/user.svg)](https://www.npmjs.com/package/@xmcl/user) |
| [@xmcl/mod-parser](../packages/mod-parser) | ניתוח מודי Forge/LiteLoader/Fabric | [![npm](https://img.shields.io/npm/v/@xmcl/mod-parser.svg)](https://www.npmjs.com/package/@xmcl/mod-parser) |
| [@xmcl/curseforge](../packages/curseforge) | ממשק API של CurseForge | [![npm](https://img.shields.io/npm/v/@xmcl/curseforge.svg)](https://www.npmjs.com/package/@xmcl/curseforge) |
| [@xmcl/modrinth](../packages/modrinth) | ממשק API של Modrinth | [![npm](https://img.shields.io/npm/v/@xmcl/modrinth.svg)](https://www.npmjs.com/package/@xmcl/modrinth) |
| [@xmcl/nbt](../packages/nbt) | ניתוח נתוני NBT | [![npm](https://img.shields.io/npm/v/@xmcl/nbt.svg)](https://www.npmjs.com/package/@xmcl/nbt) |
| [@xmcl/game-data](../packages/game-data) | טעינת נתוני עולם או servers.dat | [![npm](https://img.shields.io/npm/v/@xmcl/game-data.svg)](https://www.npmjs.com/package/@xmcl/game-data) |
| [@xmcl/resourcepack](../packages/resourcepack) | ניתוח חבילות משאבים | [![npm](https://img.shields.io/npm/v/@xmcl/resourcepack.svg)](https://www.npmjs.com/package/@xmcl/resourcepack) |
| [@xmcl/gamesetting](../packages/gamesetting) | ניתוח הגדרות משחק | [![npm](https://img.shields.io/npm/v/@xmcl/gamesetting.svg)](https://www.npmjs.com/package/@xmcl/gamesetting) |
| [@xmcl/client](../packages/client) | כלי רשת עבור לקוח Minecraft | [![npm](https://img.shields.io/npm/v/@xmcl/client.svg)](https://www.npmjs.com/package/@xmcl/client) |
| [@xmcl/model](../packages/model) | הצגת מודלים תלת-ממדיים של שחקנים ובלוקים | [![npm](https://img.shields.io/npm/v/@xmcl/model.svg)](https://www.npmjs.com/package/@xmcl/model) |
| [@xmcl/text-component](../packages/text-component) | ניתוח רכיבי טקסט של Minecraft | [![npm](https://img.shields.io/npm/v/@xmcl/text-component.svg)](https://www.npmjs.com/package/@xmcl/text-component) |
| [@xmcl/forge-site-parser](../packages/forge-site-parser) | ניתוח אתר Forge | [![npm](https://img.shields.io/npm/v/@xmcl/forge-site-parser.svg)](https://www.npmjs.com/package/@xmcl/forge-site-parser) |
| [@xmcl/file-transfer](../packages/file-transfer) | הורדת קבצים בביצועים גבוהים | [![npm](https://img.shields.io/npm/v/@xmcl/file-transfer.svg)](https://www.npmjs.com/package/@xmcl/file-transfer) |
| [@xmcl/nat-api](../packages/nat-api) | מיפוי יציאות UPnP ו-NAT-PMP | [![npm](https://img.shields.io/npm/v/@xmcl/nat-api.svg)](https://www.npmjs.com/package/@xmcl/nat-api) |
| [@xmcl/system](../packages/system) | תווכת FS עבור דפדפן ו-Node | [![npm](https://img.shields.io/npm/v/@xmcl/system.svg)](https://www.npmjs.com/package/@xmcl/system) |
| [@xmcl/unzip](../packages/unzip) | מעטפת פריסת zip (yauzl) | [![npm](https://img.shields.io/npm/v/@xmcl/unzip.svg)](https://www.npmjs.com/package/@xmcl/unzip) |
| [@xmcl/semver](../packages/semver) | פורמט Fabric semver | [![npm](https://img.shields.io/npm/v/@xmcl/semver.svg)](https://www.npmjs.com/package/@xmcl/semver) |
| [@xmcl/bytebuffer](../packages/bytebuffer) | מימוש ByteBuffer | [![npm](https://img.shields.io/npm/v/@xmcl/bytebuffer.svg)](https://www.npmjs.com/package/@xmcl/bytebuffer) |

## תרומה לפרויקט

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Voxelum/x-minecraft-launcher)

למפתחים: עיינו ב[מדריך התרומה](CONTRIBUTING.he.md)

למתרגמים (i18n): עיינו ב[מדריך לוקליזציה](https://docs.xmcl.app/en/guide/i18n)
...
| [![](https://github.com/DGP-Studio/Snap.Hutao/assets/10614984/73ae8b90-f3c7-4033-b2b7-f4126331ce66)](https://signpath.io/) | חתימת קוד חינם ל-Windows באדיבות [SignPath.io](https://signpath.io/), תעודה מאת [SignPath Foundation](https://signpath.org/) |
| :---: | :---: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy) לאפליקציות JavaScript ללא שרת. מסופק על ידי [Deno](https://deno.com/) |
| [![](../assets/EdgeOne.png)](https://edgeone.ai/) | [Tencent EdgeOne](https://edgeone.ai/) — האצת CDN והגנת אבטחה בחסות Tencent EdgeOne. |
...
תמיכה וניהול קהילת RU/UK

**[Marmur2020](https://github.com/Marmur2020)**
תרגום מלא לאוקראינית
...
תחזוקת חבילת AUR (Arch User Repository)
...
תודה מכל הלב על התמיכה והתרומה:

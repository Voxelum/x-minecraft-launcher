...
Uygulamayı indirmek için [resmi web sitesini](https://xmcl.app) ziyaret edin!

winget yüklüyse, şu komutla yükleyebilirsiniz:

```bash
winget install CI010.XMinecraftLauncher
```

Homebrew (macOS tap) ile yükleme:
...
Linux üzerinde XMCL ayrıca Flathub üzerinden de edinilebilir:
...
- 📥 **Otomatik İndirme ve Tamamlama**. Resmi veya üçüncü taraf aynalardan `Minecraft`, `Forge`, `Fabric`, `Quilt`, `OptiFine`, `JVM` indirme desteği.
- ⚡️ **Yüksek Hızlı İndirme**. HTTP/HTTPS aracıları üzerinden soket yeniden kullanımı ve parçalı eşzamanlı dosya indirme.
- 💻 **Çapraz Platform**. Electron tabanlıdır; 🗔 Windows 10/11, 🍎 macOS ve 🐧 Linux destekler.
- 📚 **Çoklu Örnek Yönetimi**. Farklı sürümleri, modları ve başlatma ayarlarını yalıtmak için bağımsız profiller oluşturun.
- 🗂 **Akıllı Kaynak Yönetimi**. Dosya kopyalamayı önlemek ve disk alanından tasarruf etmek için sabit ve sembolik bağlantılar kullanır! 😆
- 🔥 **Entegre CurseForge & Modrinth**. Başlatıcı içinden doğrudan modları ve kaynak paketlerini arayın ve indirin.
- 📦 **Mod Paketi İçe/Dışa Aktarma**. CurseForge ve Modrinth mod paketi formatlarıyla tam uyumluluk!
- 🔒 **Çoklu Hesap Desteği**. Microsoft girişi, Mojang Yggdrasil API, [ely.by](https://ely.by/), [littleskin.cn](https://littleskin.cn) ve özel kimlik doğrulama sunucuları!
- 🔗 **P2P Çok Oyunculu**. İnternet üzerinden sanal LAN ile arkadaşlarınızla karmaşık ağ ayarları olmadan oynayın!
- 🔑 **Kod İmzalama ve Modern Paketleme**. Windows altında SmartScreen uyarıları olmadan `appx` ve `appinstaller` desteği! 😎

## Çekirdek Kütüphaneler (Core Libraries)

Bu depo ayrıca bir Minecraft başlatıcısı oluşturmak için işlevler sağlayan **Minecraft Launcher Core** (`@xmcl/*` paketleri) npm paketlerini içerir. [API Belgeleri](https://docs.xmcl.app/en/core)

| Package | Description | Version |
| --- | --- | --- |
| [@xmcl/core](../packages/core) | Minecraft başlatma | [![npm](https://img.shields.io/npm/v/@xmcl/core.svg)](https://www.npmjs.com/package/@xmcl/core) |
| [@xmcl/installer](../packages/installer) | Minecraft, Forge, Fabric, Quilt, OptiFine, JVM kurulumu | [![npm](https://img.shields.io/npm/v/@xmcl/installer.svg)](https://www.npmjs.com/package/@xmcl/installer) |
| [@xmcl/user](../packages/user) | Kullanıcı kimlik doğrulaması ve dış görünüm yönetimi | [![npm](https://img.shields.io/npm/v/@xmcl/user.svg)](https://www.npmjs.com/package/@xmcl/user) |
| [@xmcl/mod-parser](../packages/mod-parser) | Forge/LiteLoader/Fabric modlarını ayrıştırma | [![npm](https://img.shields.io/npm/v/@xmcl/mod-parser.svg)](https://www.npmjs.com/package/@xmcl/mod-parser) |
...
| [@xmcl/nbt](../packages/nbt) | NBT ayrıştırma | [![npm](https://img.shields.io/npm/v/@xmcl/nbt.svg)](https://www.npmjs.com/package/@xmcl/nbt) |
| [@xmcl/game-data](../packages/game-data) | Dünya verilerini veya servers.dat dosyasını yükleme | [![npm](https://img.shields.io/npm/v/@xmcl/game-data.svg)](https://www.npmjs.com/package/@xmcl/game-data) |
| [@xmcl/resourcepack](../packages/resourcepack) | Kaynak paketlerini ayrıştırma | [![npm](https://img.shields.io/npm/v/@xmcl/resourcepack.svg)](https://www.npmjs.com/package/@xmcl/resourcepack) |
| [@xmcl/gamesetting](../packages/gamesetting) | Oyun ayarlarını ayrıştırma | [![npm](https://img.shields.io/npm/v/@xmcl/gamesetting.svg)](https://www.npmjs.com/package/@xmcl/gamesetting) |
| [@xmcl/client](../packages/client) | Minecraft istemcisi ağ yardımcı programları | [![npm](https://img.shields.io/npm/v/@xmcl/client.svg)](https://www.npmjs.com/package/@xmcl/client) |
| [@xmcl/model](../packages/model) | Oyuncu ve blok 3B modellerini görüntüleme | [![npm](https://img.shields.io/npm/v/@xmcl/model.svg)](https://www.npmjs.com/package/@xmcl/model) |
| [@xmcl/text-component](../packages/text-component) | Minecraft metin bileşenlerini ayrıştırma | [![npm](https://img.shields.io/npm/v/@xmcl/text-component.svg)](https://www.npmjs.com/package/@xmcl/text-component) |
| [@xmcl/forge-site-parser](../packages/forge-site-parser) | Forge web sitesini ayrıştırma | [![npm](https://img.shields.io/npm/v/@xmcl/forge-site-parser.svg)](https://www.npmjs.com/package/@xmcl/forge-site-parser) |
| [@xmcl/file-transfer](../packages/file-transfer) | Yüksek performanslı dosya indirme | [![npm](https://img.shields.io/npm/v/@xmcl/file-transfer.svg)](https://www.npmjs.com/package/@xmcl/file-transfer) |
| [@xmcl/nat-api](../packages/nat-api) | UPnP ve NAT-PMP bağlantı noktası eşleme | [![npm](https://img.shields.io/npm/v/@xmcl/nat-api.svg)](https://www.npmjs.com/package/@xmcl/nat-api) |
| [@xmcl/system](../packages/system) | Tarayıcı/Node için FS ara katman yazılımı | [![npm](https://img.shields.io/npm/v/@xmcl/system.svg)](https://www.npmjs.com/package/@xmcl/system) |
| [@xmcl/unzip](../packages/unzip) | yauzl zip çıkarma sarmalayıcısı | [![npm](https://img.shields.io/npm/v/@xmcl/unzip.svg)](https://www.npmjs.com/package/@xmcl/unzip) |
| [@xmcl/semver](../packages/semver) | Fabric semver formatı | [![npm](https://img.shields.io/npm/v/@xmcl/semver.svg)](https://www.npmjs.com/package/@xmcl/semver) |
| [@xmcl/bytebuffer](../packages/bytebuffer) | ByteBuffer uygulaması | [![npm](https://img.shields.io/npm/v/@xmcl/bytebuffer.svg)](https://www.npmjs.com/package/@xmcl/bytebuffer) |

## Katkıda Bulunma

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Voxelum/x-minecraft-launcher)

Geliştiriciler için: [Katkı Kılavuzuna](CONTRIBUTING.tr.md) bakın

Çevirmenler (i18n) için: [Yerelleştirmeye Başlarken](https://docs.xmcl.app/en/guide/i18n) kılavuzuna bakın
...
| [![](https://github.com/DGP-Studio/Snap.Hutao/assets/10614984/73ae8b90-f3c7-4033-b2b7-f4126331ce66)](https://signpath.io/) | [SignPath.io](https://signpath.io/) tarafından sağlanan ücretsiz Windows kod imzalama, sertifika: [SignPath Foundation](https://signpath.org/) |
| :---: | :---: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | Sunucusuz JavaScript uygulamaları için [Deno Deploy](https://deno.com/deploy). [Deno](https://deno.com/) tarafından sağlanmıştır |
| [![](../assets/EdgeOne.png)](https://edgeone.ai/) | [Tencent EdgeOne](https://edgeone.ai/) — CDN hızlandırması ve güvenlik koruması Tencent EdgeOne tarafından desteklenmektedir. |
...
AUR (Arch User Repository) paketi bakımı

**[0xc0000142](https://github.com/0xc0000142)**
winget paketi bakımı

### 🛠️ Geliştiriciler

**[lukechu10](https://github.com/lukechu10) & [HoldYourWaffle](https://github.com/HoldYourWaffle)**
Başlatıcı çekirdek mimari geliştirme

**[laolarou726](https://github.com/laolarou726)**
Başlatıcı arayüz tasarımı ve UI/UX

### 💙 Özel Teşekkürler

Destek ve katkılarından dolayı bu kişilere içtenlikle teşekkür ederiz:

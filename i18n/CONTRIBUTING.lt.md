### Technologijų krūva ir architektūra

Projekte naudojamos technologijos ir įrankiai:

- [Node.js >=18.17.0](https://nodejs.org/): Pagrindinių bibliotekų vykdymo aplinka.
- [Electron 27](https://electron.atom.io): Darbalaukio programos platforma.
- [pnpm](https://pnpm.io/): Monorepo paketų tvarkyklė.
- [TypeScript](https://www.typescriptlang.org/): Pagrindinė programavimo kalba.
- [Vue & Vite](https://vuejs.org/): Vartotojo sąsaja ir kūrimo sistema.
...
### Kaip pradėti prisidėti

1. **Klonuoti projektą su submoduliais**:
   ```bash
...
2. **Įdiegti priklausomybes**:
   ...
   pnpm install
   ```
3. **Paleisti kūrimo režimą**:
   ```bash
   pnpm dev
   ```
4. **Tipų ir stiliaus patikra**:
   ```bash
   pnpm check
   pnpm lint
   ```

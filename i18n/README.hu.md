...
Látogass el a [hivatalos weboldalra](https://xmcl.app) az alkalmazás letöltéséhez!

Ha rendelkezel winget csomagkezelővel:

```bash
winget install CI010.XMinecraftLauncher
```

Telepítés Homebrew (macOS tap) segítségével:
...
Linux alatt az XMCL a Flathubon is elérhető:
...
- 📥 **Automatikus letöltés és kiegészítés**. `Minecraft`, `Forge`, `Fabric`, `Quilt`, `OptiFine`, `JVM` letöltésének támogatása.
- ⚡️ **Gyors letöltés**. Kapcsolatok újrahasznosítása és párhuzamos, többszálú letöltés darabokban.
- 💻 **Platformfüggetlen**. Electron alapú, támogatja: 🗔 Windows 10/11, 🍎 macOS és 🐧 Linux.
- 📚 **Több példány kezelése**. Izolált profilok létrehozása játékverziók, modok és indítási beállítások elkülönítéséhez.
- 🗂 **Erőforrás-kezelés**. Hard és szimbolikus linkek használata a lemezterület megtakarításához másolatok nélkül! 😆
- 🔥 **Beépített CurseForge & Modrinth**. Modok és erőforráscsomagok böngészése közvetlenül a launcherben.
- 📦 **Modpack importálás és exportálás**. Teljes kompatibilitás a CurseForge és Modrinth formátumokkal!
- 🔒 **Több fiókrendszer támogatása**. Microsoft bejelentkezés, Mojang Yggdrasil API, [ely.by](https://ely.by/) és egyéni szerverek!
- 🔗 **P2P multiplayer**. Játssz barátaiddal virtuális LAN hálózaton keresztül az interneten!
- 🔑 **Kódaláírás és modern csomagok**. Windows alatt `appx` és `appinstaller` SmartScreen figyelmeztetések nélkül! 😎

## Alapkönyvtárak (Core Libraries)

Ez a tároló tartalmazza a **Minecraft Launcher Core** (`@xmcl/*`) npm csomagokat is egyedi Minecraft launcherek építéséhez. [API Dokumentáció](https://docs.xmcl.app/en/core)

| Package | Description | Version |
| --- | --- | --- |
| [@xmcl/core](../packages/core) | Minecraft indítása | [![npm](https://img.shields.io/npm/v/@xmcl/core.svg)](https://www.npmjs.com/package/@xmcl/core) |
| [@xmcl/installer](../packages/installer) | Minecraft, Forge, Fabric, Quilt, OptiFine, JVM telepítése | [![npm](https://img.shields.io/npm/v/@xmcl/installer.svg)](https://www.npmjs.com/package/@xmcl/installer) |
| [@xmcl/user](../packages/user) | Felhasználói hitelesítés és skinek | [![npm](https://img.shields.io/npm/v/@xmcl/user.svg)](https://www.npmjs.com/package/@xmcl/user) |
| [@xmcl/mod-parser](../packages/mod-parser) | Forge/LiteLoader/Fabric modok feldolgozása | [![npm](https://img.shields.io/npm/v/@xmcl/mod-parser.svg)](https://www.npmjs.com/package/@xmcl/mod-parser) |
...
| [@xmcl/nbt](../packages/nbt) | NBT adatok feldolgozása | [![npm](https://img.shields.io/npm/v/@xmcl/nbt.svg)](https://www.npmjs.com/package/@xmcl/nbt) |
| [@xmcl/game-data](../packages/game-data) | Világadatok vagy servers.dat betöltése | [![npm](https://img.shields.io/npm/v/@xmcl/game-data.svg)](https://www.npmjs.com/package/@xmcl/game-data) |
| [@xmcl/resourcepack](../packages/resourcepack) | Erőforráscsomagok feldolgozása | [![npm](https://img.shields.io/npm/v/@xmcl/resourcepack.svg)](https://www.npmjs.com/package/@xmcl/resourcepack) |
| [@xmcl/gamesetting](../packages/gamesetting) | Játékbeállítások feldolgozása | [![npm](https://img.shields.io/npm/v/@xmcl/gamesetting.svg)](https://www.npmjs.com/package/@xmcl/gamesetting) |
| [@xmcl/client](../packages/client) | Minecraft kliens hálózati segédprogramok | [![npm](https://img.shields.io/npm/v/@xmcl/client.svg)](https://www.npmjs.com/package/@xmcl/client) |
| [@xmcl/model](../packages/model) | Játékos és blokk 3D modellek megjelenítése | [![npm](https://img.shields.io/npm/v/@xmcl/model.svg)](https://www.npmjs.com/package/@xmcl/model) |
| [@xmcl/text-component](../packages/text-component) | Minecraft szövegkomponensek feldolgozása | [![npm](https://img.shields.io/npm/v/@xmcl/text-component.svg)](https://www.npmjs.com/package/@xmcl/text-component) |
| [@xmcl/forge-site-parser](../packages/forge-site-parser) | Forge weboldal feldolgozása | [![npm](https://img.shields.io/npm/v/@xmcl/forge-site-parser.svg)](https://www.npmjs.com/package/@xmcl/forge-site-parser) |
| [@xmcl/file-transfer](../packages/file-transfer) | Nagy teljesítményű fájlletöltések | [![npm](https://img.shields.io/npm/v/@xmcl/file-transfer.svg)](https://www.npmjs.com/package/@xmcl/file-transfer) |
| [@xmcl/nat-api](../packages/nat-api) | UPnP és NAT-PMP portkezelés | [![npm](https://img.shields.io/npm/v/@xmcl/nat-api.svg)](https://www.npmjs.com/package/@xmcl/nat-api) |
| [@xmcl/system](../packages/system) | FS köztesréteg böngészőhöz és Node-hoz | [![npm](https://img.shields.io/npm/v/@xmcl/system.svg)](https://www.npmjs.com/package/@xmcl/system) |
| [@xmcl/unzip](../packages/unzip) | yauzl zip kibontó wrapper | [![npm](https://img.shields.io/npm/v/@xmcl/unzip.svg)](https://www.npmjs.com/package/@xmcl/unzip) |
| [@xmcl/semver](../packages/semver) | Fabric semver formátum | [![npm](https://img.shields.io/npm/v/@xmcl/semver.svg)](https://www.npmjs.com/package/@xmcl/semver) |
| [@xmcl/bytebuffer](../packages/bytebuffer) | ByteBuffer implementáció | [![npm](https://img.shields.io/npm/v/@xmcl/bytebuffer.svg)](https://www.npmjs.com/package/@xmcl/bytebuffer) |

## Hozzájárulás

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Voxelum/x-minecraft-launcher)

Fejlesztőknek: lásd a [Hozzájárulási útmutatót](CONTRIBUTING.hu.md)

Fordítóknak (i18n): lásd a [Honosítási útmutatót](https://docs.xmcl.app/en/guide/i18n)
...
| [![](https://github.com/DGP-Studio/Snap.Hutao/assets/10614984/73ae8b90-f3c7-4033-b2b7-f4126331ce66)](https://signpath.io/) | Ingyenes Windows kódaláírás: [SignPath.io](https://signpath.io/), tanúsítvány: [SignPath Foundation](https://signpath.org/) |
| :---: | :---: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy) szerver nélküli JavaScript alkalmazásokhoz. Támogató: [Deno](https://deno.com/) |
| [![](../assets/EdgeOne.png)](https://edgeone.ai/) | [Tencent EdgeOne](https://edgeone.ai/) — CDN gyorsítás és biztonság a Tencent EdgeOne támogatásával. |
...
## Köszönetnyilvánítás és Szerzők

### 🌍 Közösség és Honosítás

**[BANSAFAn/Baneronetwo](https://github.com/BANSAFAn)**
RU/UK közösségi támogatás és moderáció

**[Marmur2020](https://github.com/Marmur2020)**
Teljes ukrán fordítás
...
Szívből jövő köszönet a támogatásért és segítségért:

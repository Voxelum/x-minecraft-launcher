...
ऐप डाउनलोड करने के लिए [आधिकारिक वेबसाइट](https://xmcl.app) पर जाएं!

यदि आपके पास winget स्थापित है:

```bash
winget install CI010.XMinecraftLauncher
```

Homebrew (macOS tap) के माध्यम से स्थापना:
...
Linux पर, XMCL Flathub पर भी उपलब्ध है:
...
- 📥 **स्वचालित डाउनलोड और पूर्णता**। आधिकारिक या तीसरे पक्ष के स्रोतों से `Minecraft`, `Forge`, `Fabric`, `Quilt`, `OptiFine`, `JVM` डाउनलोड समर्थन।
- ⚡️ **अति तेज़ डाउनलोड**। HTTP/HTTPS एजेंटों के माध्यम से कनेक्शन पुनर्चक्रण और बहु-थ्रेडेड समानांतर डाउनलोड।
- 💻 **क्रॉस प्लेटफ़ॉर्म**। Electron पर आधारित: 🗔 Windows 10/11, 🍎 macOS और 🐧 Linux का पूर्ण समर्थन।
- 📚 **मल्टी-इंस्टेंस प्रबंधन**। संस्करणों, मॉड और सेटिंग्स को अलग रखने के लिए स्वतंत्र प्रोफाइल बनाएं।
- 🗂 **कुशल संसाधन प्रबंधन**। बिना फ़ाइलों की नकल किए डिस्क स्थान बचाने के लिए हार्ड और सिम्बोलिक लिंक का उपयोग! 😆
- 🔥 **CurseForge और Modrinth एकीकरण**। सीधे लॉन्चर के अंदर मॉड और संसाधन पैक खोजें और डाउनलोड करें।
- 📦 **मॉडपैक आयात और निर्यात**। CurseForge और Modrinth मानकों के साथ पूर्ण अनुकूलता!
- 🔒 **एकाधिक खाता प्रणाली**। Microsoft लॉगिन, Mojang Yggdrasil API, [ely.by](https://ely.by/) और कस्टम प्रमाणीकरण सर्वर!
- 🔗 **P2P मल्टीप्लेयर**। बिना जटिल नेटवर्क सेटिंग्स के इंटरनेट पर वर्चुअल LAN के माध्यम से दोस्तों के साथ खेलें!
- 🔑 **कोड साइनिंग और आधुनिक पैकेजिंग**। Windows पर SmartScreen चेतावनियों के बिना `appx` और `appinstaller` का समर्थन! 😎

## मुख्य लाइब्रेरीज़ (Core Libraries)

इस रिपॉजिटरी में **Minecraft Launcher Core** (`@xmcl/*` पैकेज) भी शामिल हैं — Minecraft लॉन्चर बनाने के लिए उपयोगी npm पैकेज। [API दस्तावेज़](https://docs.xmcl.app/en/core)

| Package | Description | Version |
| --- | --- | --- |
| [@xmcl/core](../packages/core) | Minecraft लॉन्च करना | [![npm](https://img.shields.io/npm/v/@xmcl/core.svg)](https://www.npmjs.com/package/@xmcl/core) |
| [@xmcl/installer](../packages/installer) | Minecraft, Forge, Fabric, Quilt, OptiFine, JVM स्थापित करना | [![npm](https://img.shields.io/npm/v/@xmcl/installer.svg)](https://www.npmjs.com/package/@xmcl/installer) |
| [@xmcl/user](../packages/user) | उपयोगकर्ता प्रमाणीकरण और स्किन्स | [![npm](https://img.shields.io/npm/v/@xmcl/user.svg)](https://www.npmjs.com/package/@xmcl/user) |
| [@xmcl/mod-parser](../packages/mod-parser) | Forge/LiteLoader/Fabric मॉड्स का विश्लेषण | [![npm](https://img.shields.io/npm/v/@xmcl/mod-parser.svg)](https://www.npmjs.com/package/@xmcl/mod-parser) |
...
| [@xmcl/nbt](../packages/nbt) | NBT डेटा का विश्लेषण | [![npm](https://img.shields.io/npm/v/@xmcl/nbt.svg)](https://www.npmjs.com/package/@xmcl/nbt) |
| [@xmcl/game-data](../packages/game-data) | विश्व डेटा या servers.dat लोड करना | [![npm](https://img.shields.io/npm/v/@xmcl/game-data.svg)](https://www.npmjs.com/package/@xmcl/game-data) |
| [@xmcl/resourcepack](../packages/resourcepack) | संसाधन पैक का विश्लेषण | [![npm](https://img.shields.io/npm/v/@xmcl/resourcepack.svg)](https://www.npmjs.com/package/@xmcl/resourcepack) |
| [@xmcl/gamesetting](../packages/gamesetting) | गेम सेटिंग्स का विश्लेषण | [![npm](https://img.shields.io/npm/v/@xmcl/gamesetting.svg)](https://www.npmjs.com/package/@xmcl/gamesetting) |
| [@xmcl/client](../packages/client) | Minecraft क्लाइंट नेटवर्क उपयोगिताएं | [![npm](https://img.shields.io/npm/v/@xmcl/client.svg)](https://www.npmjs.com/package/@xmcl/client) |
| [@xmcl/model](../packages/model) | खिलाड़ियों और ब्लॉकों के 3D मॉडल प्रदर्शित करना | [![npm](https://img.shields.io/npm/v/@xmcl/model.svg)](https://www.npmjs.com/package/@xmcl/model) |
| [@xmcl/text-component](../packages/text-component) | Minecraft टेक्स्ट घटकों का विश्लेषण | [![npm](https://img.shields.io/npm/v/@xmcl/text-component.svg)](https://www.npmjs.com/package/@xmcl/text-component) |
| [@xmcl/forge-site-parser](../packages/forge-site-parser) | Forge वेबसाइट का विश्लेषण | [![npm](https://img.shields.io/npm/v/@xmcl/forge-site-parser.svg)](https://www.npmjs.com/package/@xmcl/forge-site-parser) |
| [@xmcl/file-transfer](../packages/file-transfer) | उच्च प्रदर्शन फ़ाइल डाउनलोड | [![npm](https://img.shields.io/npm/v/@xmcl/file-transfer.svg)](https://www.npmjs.com/package/@xmcl/file-transfer) |
| [@xmcl/nat-api](../packages/nat-api) | UPnP और NAT-PMP पोर्ट मैपिंग | [![npm](https://img.shields.io/npm/v/@xmcl/nat-api.svg)](https://www.npmjs.com/package/@xmcl/nat-api) |
| [@xmcl/system](../packages/system) | ब्राउज़र/Node के लिए FS मिडलवेयर | [![npm](https://img.shields.io/npm/v/@xmcl/system.svg)](https://www.npmjs.com/package/@xmcl/system) |
| [@xmcl/unzip](../packages/unzip) | yauzl zip निष्कर्षण रैपर | [![npm](https://img.shields.io/npm/v/@xmcl/unzip.svg)](https://www.npmjs.com/package/@xmcl/unzip) |
| [@xmcl/semver](../packages/semver) | Fabric semver प्रारूप | [![npm](https://img.shields.io/npm/v/@xmcl/semver.svg)](https://www.npmjs.com/package/@xmcl/semver) |
| [@xmcl/bytebuffer](../packages/bytebuffer) | ByteBuffer कार्यान्वयन | [![npm](https://img.shields.io/npm/v/@xmcl/bytebuffer.svg)](https://www.npmjs.com/package/@xmcl/bytebuffer) |

## योगदान दें

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Voxelum/x-minecraft-launcher)

डेवलपर्स के लिए: [योगदान गाइड](CONTRIBUTING.hi.md) देखें

अनुवादकों (i18n) के लिए: [स्थानीयकरण गाइड](https://docs.xmcl.app/en/guide/i18n) देखें
...
| [![](https://github.com/DGP-Studio/Snap.Hutao/assets/10614984/73ae8b90-f3c7-4033-b2b7-f4126331ce66)](https://signpath.io/) | [SignPath.io](https://signpath.io/) द्वारा Windows के लिए निःशुल्क कोड हस्ताक्षर, प्रमाणपत्र: [SignPath Foundation](https://signpath.org/) |
| :---: | :---: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | सर्वर रहित JavaScript अनुप्रयोगों के लिए [Deno Deploy](https://deno.com/deploy)। [Deno](https://deno.com/) द्वारा प्रदान किया गया |
| [![](../assets/EdgeOne.png)](https://edgeone.ai/) | [Tencent EdgeOne](https://edgeone.ai/) — Tencent EdgeOne द्वारा प्रायोजित CDN त्वरण और सुरक्षा सुरक्षा। |
...
AUR (Arch User Repository) पैकेज रखरखाव
...
लॉन्चर डिज़ाइन और UI/UX

### 💙 विशेष धन्यवाद

समर्थन और योगदान के लिए हार्दिक धन्यवाद:

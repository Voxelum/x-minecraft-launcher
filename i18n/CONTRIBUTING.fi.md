...
Katsaus projektissa käytettyihin työkaluihin:

- [Node.js >=18.17.0](https://nodejs.org/): Ydinkirjastojen suoritusympäristö.
- [Electron 27](https://electron.atom.io): Työpöytäsovelluksen alusta.
- [pnpm](https://pnpm.io/): Monorepon paketinhallinta.
- [TypeScript](https://www.typescriptlang.org/): Pääohjelmointikieli.
- [Vue & Vite](https://vuejs.org/): Käyttöliittymä ja käännöstyökalut.
...
1. **Kloonaa repositorio alimoduuleineen**:
   ```bash

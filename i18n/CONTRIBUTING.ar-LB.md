...
- [Node.js >=18.17.0](https://nodejs.org/): بيئة تشغيل المكتبات الأساسية.
- [Electron 27](https://electron.atom.io): بيئة تشغيل سطح المكتب.
- [pnpm](https://pnpm.io/): إدارة الحزم.
- [TypeScript](https://www.typescriptlang.org/): لغة البرمجة الأساسية.
- [Vue & Vite](https://vuejs.org/): واجهة المستخدم.

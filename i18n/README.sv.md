...
Besök den [officiella webbplatsen](https://xmcl.app) för att ladda ner appen!

Om du har winget installerat kan du köra:

```bash
winget install CI010.XMinecraftLauncher
```

Installation via Homebrew (macOS tap):
...
På Linux finns XMCL även på Flathub:
...
- 📥 **Automatisk nedladdning och komplettering**. Stöd för att ladda ner `Minecraft`, `Forge`, `Fabric`, `Quilt`, `OptiFine`, `JVM` från officiella eller tredjepartsspeglar.
- ⚡️ **Blixtsnabb nedladdning**. Återanvänder sockets via HTTP/HTTPS-agenter och laddar ner filer i delar samtidigt.
- 💻 **Plattformsoberoende**. Byggd på Electron med fullt stöd för 🗔 Windows 10/11, 🍎 macOS och 🐧 Linux.
- 📚 **Hantering av flera instanser**. Skapa isolerade profiler för att hålla isär versioner, moddar och startinställningar.
- 🗂 **Smart resurshantering**. Använder hårda och symboliska länkar för att undvika dubbla filer och spara diskutrymme! 😆
- 🔥 **Inbyggd CurseForge & Modrinth**. Sök och ladda ner moddar och resurspaket direkt i startprogrammet.
- 📦 **Importera & exportera modpaket**. Full kompatibilitet med CurseForge- och Modrinth-format!
- 🔒 **Stöd för flera konton**. Microsoft-inloggning, Mojang Yggdrasil API, [ely.by](https://ely.by/) och anpassade autentiseringsservrar!
- 🔗 **P2P-flerspelarläge**. Spela med vänner över virtuellt LAN via internet utan krångliga nätverksinställningar!
- 🔑 **Kodsignering & moderna paket**. På Windows stöds `appx` och `appinstaller` utan SmartScreen-varningar! 😎

## Kärnbibliotek (Core Libraries)

Detta repository innehåller även **Minecraft Launcher Core** (`@xmcl/*`-paket) — en uppsättning npm-paket för att bygga en Minecraft-startare. [API-dokumentation](https://docs.xmcl.app/en/core)

| Package | Description | Version |
| --- | --- | --- |
| [@xmcl/core](../packages/core) | Starta Minecraft | [![npm](https://img.shields.io/npm/v/@xmcl/core.svg)](https://www.npmjs.com/package/@xmcl/core) |
| [@xmcl/installer](../packages/installer) | Installera Minecraft, Forge, Fabric, Quilt, OptiFine, JVM | [![npm](https://img.shields.io/npm/v/@xmcl/installer.svg)](https://www.npmjs.com/package/@xmcl/installer) |
| [@xmcl/user](../packages/user) | Användarautentisering och skal | [![npm](https://img.shields.io/npm/v/@xmcl/user.svg)](https://www.npmjs.com/package/@xmcl/user) |
| [@xmcl/mod-parser](../packages/mod-parser) | Tolka Forge/LiteLoader/Fabric-moddar | [![npm](https://img.shields.io/npm/v/@xmcl/mod-parser.svg)](https://www.npmjs.com/package/@xmcl/mod-parser) |
...
| [@xmcl/nbt](../packages/nbt) | Tolka NBT-data | [![npm](https://img.shields.io/npm/v/@xmcl/nbt.svg)](https://www.npmjs.com/package/@xmcl/nbt) |
| [@xmcl/game-data](../packages/game-data) | Ladda världsdata eller servers.dat | [![npm](https://img.shields.io/npm/v/@xmcl/game-data.svg)](https://www.npmjs.com/package/@xmcl/game-data) |
| [@xmcl/resourcepack](../packages/resourcepack) | Tolka resurspaket | [![npm](https://img.shields.io/npm/v/@xmcl/resourcepack.svg)](https://www.npmjs.com/package/@xmcl/resourcepack) |
| [@xmcl/gamesetting](../packages/gamesetting) | Tolka spelinställningar | [![npm](https://img.shields.io/npm/v/@xmcl/gamesetting.svg)](https://www.npmjs.com/package/@xmcl/gamesetting) |
| [@xmcl/client](../packages/client) | Nätverksverktyg för Minecraft-klienten | [![npm](https://img.shields.io/npm/v/@xmcl/client.svg)](https://www.npmjs.com/package/@xmcl/client) |
| [@xmcl/model](../packages/model) | Visa 3D-modeller av spelare och block | [![npm](https://img.shields.io/npm/v/@xmcl/model.svg)](https://www.npmjs.com/package/@xmcl/model) |
| [@xmcl/text-component](../packages/text-component) | Tolka Minecraft-textkomponenter | [![npm](https://img.shields.io/npm/v/@xmcl/text-component.svg)](https://www.npmjs.com/package/@xmcl/text-component) |
| [@xmcl/forge-site-parser](../packages/forge-site-parser) | Tolka Forge-webbplatsen | [![npm](https://img.shields.io/npm/v/@xmcl/forge-site-parser.svg)](https://www.npmjs.com/package/@xmcl/forge-site-parser) |
| [@xmcl/file-transfer](../packages/file-transfer) | Högpresterande filnedladdningar | [![npm](https://img.shields.io/npm/v/@xmcl/file-transfer.svg)](https://www.npmjs.com/package/@xmcl/file-transfer) |
| [@xmcl/nat-api](../packages/nat-api) | UPnP- och NAT-PMP-portmappning | [![npm](https://img.shields.io/npm/v/@xmcl/nat-api.svg)](https://www.npmjs.com/package/@xmcl/nat-api) |
| [@xmcl/system](../packages/system) | FS-middleware för webbläsare/Node | [![npm](https://img.shields.io/npm/v/@xmcl/system.svg)](https://www.npmjs.com/package/@xmcl/system) |
| [@xmcl/unzip](../packages/unzip) | yauzl zip-extraheringsomslag | [![npm](https://img.shields.io/npm/v/@xmcl/unzip.svg)](https://www.npmjs.com/package/@xmcl/unzip) |
...
| [@xmcl/bytebuffer](../packages/bytebuffer) | ByteBuffer-implementering | [![npm](https://img.shields.io/npm/v/@xmcl/bytebuffer.svg)](https://www.npmjs.com/package/@xmcl/bytebuffer) |

## Bidra

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Voxelum/x-minecraft-launcher)

För utvecklare: se [Bidragsguide](CONTRIBUTING.sv.md)

För översättare (i18n): se [Kom igång med lokalisering](https://docs.xmcl.app/en/guide/i18n)
...
| [![](https://github.com/DGP-Studio/Snap.Hutao/assets/10614984/73ae8b90-f3c7-4033-b2b7-f4126331ce66)](https://signpath.io/) | Gratis Windows-kodsignering tillhandahålls av [SignPath.io](https://signpath.io/), certifikat från [SignPath Foundation](https://signpath.org/) |
| :---: | :---: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy) för serverlösa JavaScript-applikationer. Tillhandahålls av [Deno](https://deno.com/) |
| [![](../assets/EdgeOne.png)](https://edgeone.ai/) | [Tencent EdgeOne](https://edgeone.ai/) — CDN-acceleration och säkerhetsskydd sponsras av Tencent EdgeOne. |
...
### 🌍 Gemenskap & Lokalisering

**[BANSAFAn/Baneronetwo](https://github.com/BANSAFAn)**
Stöd och moderering av RU/UK-gemenskapen

**[Marmur2020](https://github.com/Marmur2020)**
Fullständig ukrainsk översättning
...
Ett varmt tack till dessa personer för deras stöd och bidrag:

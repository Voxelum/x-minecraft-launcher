...
Wenn Sie winget installiert haben, können Sie es zur Installation verwenden:

```bash
winget install CI010.XMinecraftLauncher
```

Installation über Homebrew (macOS Tap):
...
Unter Linux ist XMCL auch auf Flathub verfügbar:
...
- 📥 **Automatischer Download & Vervollständigung**. Unterstützt den Download von `Minecraft`, `Forge`, `Fabric`, `Quilt`, `OptiFine`, `JVM` von offiziellen oder Drittanbieter-Mirrors.
- ⚡️ **Schneller Download**. Socket-Wiederverwendung über HTTP/HTTPS-Agents und paralleler Download von Dateiteilen.
- 💻 **Plattformübergreifend**. Der Launcher basiert auf Electron und unterstützt 🗔 Windows 10/11, 🍎 macOS und 🐧 Linux.
- 📚 **Multi-Instanzen**. Erstellen Sie isolierte Profile für verschiedene Spielversionen, Mods und Starteinstellungen.
- 🗂 **Effiziente Ressourcenverwaltung**. Nutzt Hardlinks und symbolische Links, um redundante Mod-Dateien zu vermeiden und Speicherplatz zu sparen! 😆
- 🔥 **Integrierte Unterstützung für CurseForge & Modrinth**. Durchsuchen und laden Sie Ressourcen direkt im Launcher herunter.
- 📦 **Modpack Import/Export**. Vollständige Unterstützung für offizielle CurseForge- und Modrinth-Modpack-Formate!
- 🔒 **Multi-Account-Unterstützung**. Microsoft-Login, Mojang Yggdrasil API, [ely.by](https://ely.by/) und benutzerdefinierte Authentifizierungsserver!
- 🔗 **P2P-Multiplayer**. Spielen Sie mit Freunden über virtuelles LAN über das Internet ohne komplizierte Einrichtung!
- 🔑 **Codesignatur & moderne Pakete**. Unter Windows werden `appx` und `appinstaller` ohne Browser- oder SmartScreen-Warnungen unterstützt! 😎

## Kernbibliotheken (Core Libraries)

Dieses Repository enthält auch den **Minecraft Launcher Core** (`@xmcl/*` Pakete) — npm-Pakete für die Erstellung von Minecraft-Launchern. [API-Dokumentation](https://docs.xmcl.app/en/core)

| Package | Description | Version |
| --- | --- | --- |
| [@xmcl/core](../packages/core) | Minecraft starten | [![npm](https://img.shields.io/npm/v/@xmcl/core.svg)](https://www.npmjs.com/package/@xmcl/core) |
| [@xmcl/installer](../packages/installer) | Installation von Minecraft, Forge, Fabric, Quilt, OptiFine, JVM | [![npm](https://img.shields.io/npm/v/@xmcl/installer.svg)](https://www.npmjs.com/package/@xmcl/installer) |
| [@xmcl/user](../packages/user) | Benutzerauthentifizierung und Skin-Verwaltung | [![npm](https://img.shields.io/npm/v/@xmcl/user.svg)](https://www.npmjs.com/package/@xmcl/user) |
| [@xmcl/mod-parser](../packages/mod-parser) | Parsen von Forge/LiteLoader/Fabric Mods | [![npm](https://img.shields.io/npm/v/@xmcl/mod-parser.svg)](https://www.npmjs.com/package/@xmcl/mod-parser) |
...
| [@xmcl/nbt](../packages/nbt) | NBT-Daten parsen | [![npm](https://img.shields.io/npm/v/@xmcl/nbt.svg)](https://www.npmjs.com/package/@xmcl/nbt) |
| [@xmcl/game-data](../packages/game-data) | Weltdaten oder servers.dat laden | [![npm](https://img.shields.io/npm/v/@xmcl/game-data.svg)](https://www.npmjs.com/package/@xmcl/game-data) |
| [@xmcl/resourcepack](../packages/resourcepack) | Ressourcenpakete analysieren | [![npm](https://img.shields.io/npm/v/@xmcl/resourcepack.svg)](https://www.npmjs.com/package/@xmcl/resourcepack) |
| [@xmcl/gamesetting](../packages/gamesetting) | Spieleinstellungen analysieren | [![npm](https://img.shields.io/npm/v/@xmcl/gamesetting.svg)](https://www.npmjs.com/package/@xmcl/gamesetting) |
| [@xmcl/client](../packages/client) | Minecraft-Client-Netzwerk-Dienstprogramme | [![npm](https://img.shields.io/npm/v/@xmcl/client.svg)](https://www.npmjs.com/package/@xmcl/client) |
| [@xmcl/model](../packages/model) | 3D-Modelle von Spielern und Blöcken darstellen | [![npm](https://img.shields.io/npm/v/@xmcl/model.svg)](https://www.npmjs.com/package/@xmcl/model) |
| [@xmcl/text-component](../packages/text-component) | Minecraft-Textkomponenten analysieren | [![npm](https://img.shields.io/npm/v/@xmcl/text-component.svg)](https://www.npmjs.com/package/@xmcl/text-component) |
| [@xmcl/forge-site-parser](../packages/forge-site-parser) | Forge-Website parsen | [![npm](https://img.shields.io/npm/v/@xmcl/forge-site-parser.svg)](https://www.npmjs.com/package/@xmcl/forge-site-parser) |
| [@xmcl/file-transfer](../packages/file-transfer) | Hochleistungs-Dateidownloads | [![npm](https://img.shields.io/npm/v/@xmcl/file-transfer.svg)](https://www.npmjs.com/package/@xmcl/file-transfer) |
| [@xmcl/nat-api](../packages/nat-api) | UPnP- und NAT-PMP-Portweiterleitung | [![npm](https://img.shields.io/npm/v/@xmcl/nat-api.svg)](https://www.npmjs.com/package/@xmcl/nat-api) |
| [@xmcl/system](../packages/system) | FS-Middleware für Browser/Node | [![npm](https://img.shields.io/npm/v/@xmcl/system.svg)](https://www.npmjs.com/package/@xmcl/system) |
| [@xmcl/unzip](../packages/unzip) | yauzl-Zip-Entpackungs-Wrapper | [![npm](https://img.shields.io/npm/v/@xmcl/unzip.svg)](https://www.npmjs.com/package/@xmcl/unzip) |
...
| [@xmcl/bytebuffer](../packages/bytebuffer) | ByteBuffer-Implementierung | [![npm](https://img.shields.io/npm/v/@xmcl/bytebuffer.svg)](https://www.npmjs.com/package/@xmcl/bytebuffer) |

## Mitwirken

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Voxelum/x-minecraft-launcher)

Für Entwickler: siehe [Leitfaden für Beiträge](CONTRIBUTING.de.md).

Für Übersetzer (i18n): siehe [Einführung in die Lokalisierung](https://docs.xmcl.app/en/guide/i18n).
...
| [![](https://github.com/DGP-Studio/Snap.Hutao/assets/10614984/73ae8b90-f3c7-4033-b2b7-f4126331ce66)](https://signpath.io/) | Kostenlose Windows-Codesignierung bereitgestellt von [SignPath.io](https://signpath.io/), Zertifikat von [SignPath Foundation](https://signpath.org/) |
| :---: | :---: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy) für serverlose JavaScript-Anwendungen. Bereitgestellt von [Deno](https://deno.com/) |
| [![](../assets/EdgeOne.png)](https://edgeone.ai/) | [Tencent EdgeOne](https://edgeone.ai/) — CDN-Beschleunigung und Sicherheitsschutz gesponsert von Tencent EdgeOne. |
...
## Danksagungen und Autoren

### 🌍 Community & Lokalisierung

**[BANSAFAn/Baneronetwo](https://github.com/BANSAFAn)**
Community-Support und Moderation RU/UK

**[Marmur2020](https://github.com/Marmur2020)**
Vollständige ukrainische Übersetzung

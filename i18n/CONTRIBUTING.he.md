...
סקירה של הכלים והטכנולוגיות המשמשים בפרויקט:

- [Node.js >=18.17.0](https://nodejs.org/): סביבת הריצה של ספריות הליבה.
- [Electron 27](https://electron.atom.io): סביבת הריצה של אפליקציית שולחן העבודה.
- [pnpm](https://pnpm.io/): מנהל החבילות של המונורפו.
- [TypeScript](https://www.typescriptlang.org/): שפת הפיתוח המרכזית.
- [Vue & Vite](https://vuejs.org/): ממשק המשתמש ומערכת הבנייה.

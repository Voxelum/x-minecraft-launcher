...
- 🎮 **Gamepad/Controller support**. Configure wrapper commands for gamepad support through prepend commands. See [Gamepad Support Guide](docs/GAMEPAD_SUPPORT.md) for details.

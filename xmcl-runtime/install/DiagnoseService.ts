import { MinecraftFolder, diagnoseAssetIndex, diagnoseAssets, diagnoseJar, diagnoseLibraries, type AssetIndexIssue, type AssetIssue, type LibraryIssue, type MinecraftJarIssue, type ResolvedVersion } from '@xmcl/core'
import { diagnoseInstall, type InstallProfile, type InstallProfileIssueReport } from '@xmcl/installer'
import { DiagnoseServiceKey, type DiagnoseService as IDiagnoseService } from '@xmcl/runtime-api'

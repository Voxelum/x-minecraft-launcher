      ...
      app.registry.get(kFlights).then((flights) => {
        ...
        runtimeTelemetry.trackTrace({
          ...
          properties: {
            ...
            toolSuccesses: JSON.stringify(payload.toolSuccesses).slice(0, 2048),
            toolFailures: JSON.stringify(payload.toolFailures).slice(0, 2048),
            ...
            providerRequestCount: String(payload.providerRequestCount),
            providerResponseCount: String(payload.providerResponseCount),
            providerStatusClass: payload.providerStatusClass,
            firstResponseDurationMs: String(payload.firstResponseDurationMs),
            firstToolDurationMs: String(payload.firstToolDurationMs),
            documentCount: String(payload.documentCount),

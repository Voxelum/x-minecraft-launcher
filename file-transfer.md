...
<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/Voxelum/x-minecraft-launcher/blob/master/packages/file-transfer/download.ts#L111" target="_blank" rel="noreferrer">packages/file-transfer/download.ts:111</a>
</p>
...
<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/Voxelum/x-minecraft-launcher/blob/master/packages/file-transfer/controller.ts#L202" target="_blank" rel="noreferrer">packages/file-transfer/controller.ts:202</a>
</p>
...
<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/Voxelum/x-minecraft-launcher/blob/master/packages/file-transfer/controller.ts#L223" target="_blank" rel="noreferrer">packages/file-transfer/controller.ts:223</a>
</p>
...
```ts
DownloadMultipleOption: Pick<DownloadOptions, "url" | "headers" | "destination" | "expectedTotal">
```
<p style="font-size: 14px; color: var(--vp-c-text-2)">
...
```ts
ManagedAbortReason: "ttfb" | "stall" | "slow"
```
...
<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/Voxelum/x-minecraft-launcher/blob/master/packages/file-transfer/controller.ts#L185" target="_blank" rel="noreferrer">packages/file-transfer/controller.ts:185</a>
</p>

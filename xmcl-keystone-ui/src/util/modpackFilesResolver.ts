import { getInstanceConfigFromCurseforgeModpack, getInstanceConfigFromMcbbsModpack, getInstanceConfigFromMmcModpack, getInstanceConfigFromModrinthModpack } from '@xmcl/instance'

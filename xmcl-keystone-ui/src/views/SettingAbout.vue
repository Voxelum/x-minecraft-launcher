    ...
    <v-expansion-panels>
      <v-expansion-panel>
        ...
        <v-expansion-panel-text>
          ...
          >
            <div>
              <v-card-title class="w-full flex mr-2 text-h6">
                <v-img
              ...
              <v-textarea
                ...
                readonly
                class="px-4"
                :model-value="debugInfo"
              />
            </div>


            <v-card-text class="contributors">
              <v-list-subheader> 🧑‍💻 Contributors </v-list-subheader>
              <a
            ...
            <v-card-text class="sponsors flex flex-col items-center gap-3">
              <span class="text-h5"> 😇 SPONSORS 😇 </span>
              ...
              <div class="grid grid-cols-2 w-full">
                ...
                <div class="flex flex-col items-center justify-center">
                  ...
                  <div class="text-caption mb-4">
                    XMCL leverages Deno Deploy's hassle-free platform for serverless
                    JavaScript
                    applications
                  </div>
                </div>

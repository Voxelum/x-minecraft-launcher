<template>
  <div class="w-full">
    <div class="relative mx-6 flex-grow flex gap-6 items-end">
      <v-card class="rounded-lg tabs-card" color="transparent">
        <div class="flex absolute top-0 h-4 z-4 right-0 p-1">
          <div class="flex-grow" />
          <!-- <v-btn icon small @click="onMinimize">
            <v-icon>
              minimize
            </v-icon>
          </v-btn> -->
...
const { t } = useI18n()
const isMinimized = useQuery('minimized', () => false)

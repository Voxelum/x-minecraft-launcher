...
export function createServiceFactory(store: Store<any>) {
  ...
  factory.register(ModrinthServiceKey, ModrinthServiceMethods, [ResourceServiceKey], (res) => new ModrinthState(res))

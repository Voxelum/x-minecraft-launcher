...
import { compareRelease, getExpectVersion, isSameForgeVersion, parseOptifineVersion } from '/@shared/entities/version'
...
export default class DiagnoseService extends Service {
    ...
    async fixNoJava () {
      this.aquire('diagnose')
      try {
        const internalLocation = this.javaService.internalJavaLocation

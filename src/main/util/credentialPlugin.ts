...
import { ICachePlugin, Logger, LoggerOptions, TokenCacheContext } from '@azure/msal-common'
import { deletePassword, getPassword, setPassword } from 'keytar'
import { pid } from 'process'
import { CrossPlatformLock, CrossPlatformLockOptions } from './lock'
...
export class PersistenceCachePlugin implements ICachePlugin {
  public persistence: KeychainPersistence
  ...
  constructor(persistence: KeychainPersistence, lockOptions?: CrossPlatformLockOptions) {
  ...
  public async beforeCacheAccess(cacheContext: TokenCacheContext): Promise<void> {
    ...
    if (!reloadNecessary && this.currentCache) {

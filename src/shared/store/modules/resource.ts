import { CurseforgeModpackResource, FabricResource, ForgeResource, LiteloaderResource, ModpackResource, Resource, ResourcePackResource, Resources, SaveResource, UNKNOWN_RESOURCE } from '/@shared/entities/resource'

// Package migration implements contract.MigrationService.
//
...
// Service implements contract.MigrationService.
type Service struct {
	contract.MigrationServiceNotImplemented

	host   *host.Host
	states *bridge.StateManager
}

// New constructs a MigrationService bound to the given host & state manager.
...
var _ contract.MigrationService = (*Service)(nil)
